require('scripts/actions/mobskills/marionette_dice_8')

describe('Marionette Dice 8 mob skill', function()
    it('restores exactly the missing TP to 3000 and reports the increase', function()
        local dice = require('scripts/actions/mobskills/marionette_dice_8')
