require('scripts/actions/mobskills/mp_drainkiss')

describe('MP Drainkiss mob skill', function()
    it('uses its magical MP-drain request and only drains after processing', function()
        ...
        local skillObject = require('scripts/actions/mobskills/mp_drainkiss')
        ...
        assert(params.shadowBehavior == xi.mobskills.shadowBehavior.IGNORE_SHADOWS and params.dStatMultiplier == 1.5)
        assert(params.skipDamageAdjustment and params.skipMagicBonusDiff and params.skipStoneSkin)
