describe('Firebomb mob skill', function()
    it('uses its magical Fire plan and damages only after processing', function()
        local firebomb = require('scripts/actions/mobskills/firebomb')
        ...
        assert(firebomb.onMobSkillCheck(target, mob, {}) == 0)
        assert(firebomb.onMobWeaponSkill(mob, target, {}, {}) == 123)
