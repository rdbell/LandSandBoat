require('scripts/actions/mobskills/namas_arrow')

describe('Namas Arrow mob skill', function()
    it('uses its ranged plan and damages only after processing succeeds', function()
        local arrow = require('scripts/actions/mobskills/namas_arrow')
        ...
        assert(params.accuracyModifier[1] == 100 and params.accuracyModifier[2] == 100 and params.accuracyModifier[3] == 100)
