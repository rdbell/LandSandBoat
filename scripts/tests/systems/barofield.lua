require('scripts/actions/mobskills/barofield')
describe('Barofield mob skill', function()
    it('uses Wind magical plan and processed Weight', function()
        local skill = require('scripts/actions/mobskills/barofield')
        ...
        assert(params.baseDamage == 52 and params.fTP[1] == 4 and params.element == xi.element.WIND)
        ...
        assert(damage[1] == 100 and effect[1] == xi.effect.WEIGHT and effect[2] == 25 and effect[4] == 60)
    end)
end)
