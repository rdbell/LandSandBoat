require('scripts/actions/mobskills/tachi_yukikaze')
describe('Tachi Yukikaze mob skill', function()
    it('uses physical plan with Blindness on process', function()
        local skill = require('scripts/actions/mobskills/tachi_yukikaze')
        ...
        assert(params.fTP[1] == 1.5625 and params.attackMultiplier[1] == 1.33)
        assert(status[1] == xi.effect.BLINDNESS and status[2] == 25 and status[4] == 60)
