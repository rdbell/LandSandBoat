describe('Lamb Chop mob skill', function()
    it('uses its one-hit Blunt plan and damages only after processing', function()
        local chop = require('scripts/actions/mobskills/lamb_chop')
        ...
        assert(chop.onMobSkillCheck(target, mob, {}) == 0 and chop.onMobWeaponSkill(mob, target, {}, {}) == 123)
        ...
        chop.onMobWeaponSkill(mob, target, {}, {})
