require('scripts/actions/mobskills/ore_toss')
describe('Ore Toss mob skill', function()
    it('uses ranged blunt plan with distance damage scaling', function()
        local skill = require('scripts/actions/mobskills/ore_toss')
        ...
        assert(params.fTP[1] == 2.0 and params.attackType == xi.attackType.RANGED and params.skipParry)
        assert(dmg == 100)
