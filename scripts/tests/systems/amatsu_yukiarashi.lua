require('scripts/actions/mobskills/amatsu_yukiarashi')
describe('Amatsu Yukiarashi mob skill', function()
    it('uses its physical plan and processed status', function()
        local skill = require('scripts/actions/mobskills/amatsu_yukiarashi')
        ...
        assert(effect[1] == xi.effect.BLINDNESS and effect[2] == 1 and effect[4] == 60)
        assert(damage[1] == 100)
    end)
end)
