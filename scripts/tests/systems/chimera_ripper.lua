require('scripts/actions/mobskills/chimera_ripper')
describe('Chimera Ripper mob skill', function()
    it('uses TP-scaled accuracy plan and processed damage', function()
        local skill = require('scripts/actions/mobskills/chimera_ripper')
        ...
        assert(params.fTP[1] == 1.5 and params.fTP[3] == 3.0 and params.accuracyModifier[1] == 100)
