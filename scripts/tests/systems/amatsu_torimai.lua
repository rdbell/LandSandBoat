require('scripts/actions/mobskills/amatsu_torimai')
describe('Amatsu Torimai mob skill', function()
    it('uses its physical plan', function()
        local skill = require('scripts/actions/mobskills/amatsu_torimai')
