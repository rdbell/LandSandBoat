require('scripts/actions/mobskills/acheron_kick')
describe('Acheron Kick mob skill', function()
    it('uses three-hit Piercing parameters and damages only after processing', function()
        ...
        local kick = require('scripts/actions/mobskills/acheron_kick')
        ...
        assert(params.attackType == xi.attackType.PHYSICAL and params.damageType == xi.damageType.PIERCING and params.shadowBehavior == xi.mobskills.shadowBehavior.NUMSHADOWS_3 and damage == nil)
