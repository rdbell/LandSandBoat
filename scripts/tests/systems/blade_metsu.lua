require('scripts/actions/mobskills/blade_metsu')
describe('Blade Metsu mob skill', function()
    it('uses fTP 3.0 plan and processed Paralysis', function()
        local skill = require('scripts/actions/mobskills/blade_metsu')
        ...
        assert(params.fTP[1] == 3.0 and damage == nil and effect == nil)
        xi.mobskills.processDamage = function() return true end
        assert(skill.onMobWeaponSkill(mob, target, {}, {}) == 90)
        xi.mobskills.mobPhysicalMove = physicalMove
        xi.mobskills.processDamage = processDamage
        xi.mobskills.mobStatusEffectMove = statusEffectMove
        assert(damage[1] == 90 and effect[1] == xi.effect.PARALYSIS and effect[2] == 10 and effect[4] == 60)
    end)
end)
