require('scripts/actions/mobskills/double_punch')

describe('Double Punch mob skill', function()
    it('uses its two-hit physical plan and applies damage only after processing', function()
        local punch = require('scripts/actions/mobskills/double_punch')
        ...
        assert(punch.onMobSkillCheck({}, {}, {}) == 0)
        assert(punch.onMobWeaponSkill(mob, target, {}, {}) == 123)
