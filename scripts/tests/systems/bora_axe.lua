require('scripts/actions/mobskills/bora_axe')
describe('Bora Axe mob skill', function()
    it('uses physical plan with attack multiplier and Bind when processed', function()
        local skill = require('scripts/actions/mobskills/bora_axe')
        ...
        assert(params.attackMultiplier[1] == 3.5 and params.damageType == xi.damageType.SLASHING)
        assert(damage == nil and status == nil)
        xi.mobskills.processDamage = function() return true end
        assert(skill.onMobWeaponSkill(mob, target, {}, {}) == 100)
        assert(damage[1] == 100 and status[1] == xi.effect.BIND and status[4] == 20)
