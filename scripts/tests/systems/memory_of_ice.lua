require('scripts/actions/mobskills/memory_of_ice')

describe('Memory Of Ice mob skill', function()
    it('uses its Ice magical plan and damages only after processing', function()
        local memory = require('scripts/actions/mobskills/memory_of_ice')
        ...
        assert(params.element == xi.element.ICE and params.attackType == xi.attackType.MAGICAL and params.damageType == xi.damageType.ICE and params.shadowBehavior == xi.mobskills.shadowBehavior.WIPE_SHADOWS and damage == nil)
