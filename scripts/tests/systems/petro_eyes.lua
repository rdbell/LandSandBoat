require('scripts/actions/mobskills/petro_eyes')

describe('Petro Eyes mob skill', function()
    it('always allows use and applies fixed Petrification via gaze', function()
        local skill = require('scripts/actions/mobskills/petro_eyes')
        ...
        assert(params[3] == xi.effect.PETRIFICATION and params[4] == 1 and params[5] == 0 and params[6] == 420)
        assert(message == 456)
    end)
end)
