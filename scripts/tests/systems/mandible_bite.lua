require('scripts/actions/mobskills/mandible_bite')

describe('Mandible Bite mob skill', function()
    it('uses its critical piercing plan and only damages after processing', function()
        local bite = require('scripts/actions/mobskills/mandible_bite')
        ...
        assert(params.attackMultiplier[1] == 1.5 and params.attackMultiplier[2] == 1.5 and params.attackMultiplier[3] == 1.5 and params.canCrit and params.criticalChance[1] == .10 and params.criticalChance[2] == .20 and params.criticalChance[3] == .25 and params.attackType == xi.attackType.PHYSICAL and params.damageType == xi.damageType.PIERCING and params.shadowBehavior == xi.mobskills.shadowBehavior.NUMSHADOWS_1 and #calls == 2)
