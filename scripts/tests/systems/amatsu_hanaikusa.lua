require('scripts/actions/mobskills/amatsu_hanaikusa')
describe('Amatsu Hanaikusa mob skill', function()
    it('uses its physical plan and processed status', function()
        local skill = require('scripts/actions/mobskills/amatsu_hanaikusa')
        ...
        assert(effect[1] == xi.effect.PARALYSIS and effect[2] == 22 and effect[4] == 60)
        assert(damage[1] == 100)
    end)
end)
