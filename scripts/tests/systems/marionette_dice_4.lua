require('scripts/actions/mobskills/marionette_dice_4')

describe('Marionette Dice 4 mob skill', function()
    it('applies its Attack Boost and reports the gained effect', function()
        local dice = require('scripts/actions/mobskills/marionette_dice_4')
