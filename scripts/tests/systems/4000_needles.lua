require('scripts/actions/mobskills/4000_needles')
describe('4000 Needles mob skill', function()
    it('splits 4000 damage across targets with skipPDIF and guaranteed hit', function()
        local skill = require('scripts/actions/mobskills/4000_needles')
        ...
        assert(params.baseDamage == 4000/2 and params.guaranteedFirstHit == true and params.skipPDIF == true)
