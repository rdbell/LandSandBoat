require('scripts/actions/mobskills/pet_flame_breath')

describe('Pet Flame Breath mob skill', function()
    it('uses its fire breath plan and damages only after processing', function()
        local breath = require('scripts/actions/mobskills/pet_flame_breath')
        ...
        assert(params.element == xi.element.FIRE and params.attackType == xi.attackType.BREATH)
        ...
        assert(damage[1] == 123 and damage[3] == xi.attackType.BREATH and damage[4] == xi.damageType.FIRE)
    end)
end)
