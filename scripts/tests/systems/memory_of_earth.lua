require('scripts/actions/mobskills/memory_of_earth')

describe('Memory Of Earth mob skill', function()
    it('uses its Earth magical plan and damages only after processing', function()
        local memory = require('scripts/actions/mobskills/memory_of_earth')
        ...
        assert(params.element == xi.element.EARTH and params.attackType == xi.attackType.MAGICAL and params.damageType == xi.damageType.EARTH and params.shadowBehavior == xi.mobskills.shadowBehavior.WIPE_SHADOWS and damage == nil)
