describe('Flame Blast Alt mob skill', function()
    it('uses its hit-message magical Fire plan and damages only after processing', function()
        local blast = require('scripts/actions/mobskills/flame_blast_alt')
        ...
        assert(params.baseDamage == 77 and params.fTP[1] == 4 and params.fTP[2] == 4 and params.fTP[3] == 4)
        assert(params.element == xi.element.FIRE and params.attackType == xi.attackType.MAGICAL and params.damageType == xi.damageType.FIRE and params.shadowBehavior == xi.mobskills.shadowBehavior.IGNORE_SHADOWS and params.primaryMessage == xi.msg.basic.HIT_DMG and damage == nil)
