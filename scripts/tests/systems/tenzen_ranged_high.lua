require('scripts/actions/mobskills/tenzen_ranged_high')
describe('Tenzen Ranged High mob skill', function()
    it('uses ranged piercing plan fTP 1.5 with RANGED_ATTACK_HIT', function()
        local skill = require('scripts/actions/mobskills/tenzen_ranged_high')
        local params = nil
