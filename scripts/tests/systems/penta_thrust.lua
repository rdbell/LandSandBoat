require('scripts/actions/mobskills/penta_thrust')

describe('Penta Thrust mob skill', function()
    it('uses its fivefold piercing plan with accuracy modifiers and damages only after processing', function()
        local thrust = require('scripts/actions/mobskills/penta_thrust')
        ...
        assert(params.baseDamage == 77 and params.numHits == 5 and params.fTP[1] == 1)
