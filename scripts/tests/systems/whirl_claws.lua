require('scripts/actions/mobskills/whirl_claws')
describe('Whirl Claws mob skill', function()
    it('uses slashing fTP 2 three-shadow plan', function()
        local skill = require('scripts/actions/mobskills/whirl_claws')
