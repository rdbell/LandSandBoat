require('scripts/actions/mobskills/self-destruct_cluster_1_death')
describe('Self-Destruct Cluster 1 Death mob skill', function()
    it('uses fire breath plan fTP 1.0 IGNORE_SHADOWS', function()
        local skill = require('scripts/actions/mobskills/self-destruct_cluster_1_death')
        local params = nil
