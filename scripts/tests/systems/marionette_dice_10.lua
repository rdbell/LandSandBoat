require('scripts/actions/mobskills/marionette_dice_10')

describe('Marionette Dice 10 mob skill', function()
    it('applies its Defense Boost and reports the gained effect', function()
        local dice = require('scripts/actions/mobskills/marionette_dice_10')
