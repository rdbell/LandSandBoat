require('scripts/actions/mobskills/tachi_koki')
describe('Tachi Koki mob skill', function()
    it('uses hybrid physical+light plan and sums damage', function()
        local skill = require('scripts/actions/mobskills/tachi_koki')
        ...
        assert(params.hybridSkill and params.hybridSkillElement == xi.element.LIGHT and total == 80)
