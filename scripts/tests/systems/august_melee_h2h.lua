require('scripts/actions/mobskills/august_melee_h2h')
describe('August Melee H2H mob skill', function()
    it('uses one-hit plan with HIT_DMG primary message', function()
        local skill = require('scripts/actions/mobskills/august_melee_h2h')
