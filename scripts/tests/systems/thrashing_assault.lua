require('scripts/actions/mobskills/thrashing_assault')
describe('Thrashing Assault mob skill', function()
    it('uses four-hit physical plan with DEFENSE_DOWN', function()
        local skill = require('scripts/actions/mobskills/thrashing_assault')
        ...
        assert(params.numHits == 4 and status[1] == xi.effect.DEFENSE_DOWN and status[2] == 50)
