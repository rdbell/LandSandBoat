require('scripts/actions/mobskills/memory_of_fire')

describe('Memory Of Fire mob skill', function()
    it('uses its Fire magical plan and damages only after processing', function()
        local memory = require('scripts/actions/mobskills/memory_of_fire')
