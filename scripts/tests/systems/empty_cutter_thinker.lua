require('scripts/actions/mobskills/empty_cutter_thinker')

describe('Empty Cutter Thinker mob skill', function()
    it('uses its critical one-hit physical plan and damages only after processing succeeds', function()
        local cutter = require('scripts/actions/mobskills/empty_cutter_thinker')
        ...
        assert(cutter.onMobSkillCheck({}, {}, {}) == 0)
        assert(cutter.onMobWeaponSkill(mob, target, {}, {}) == 123)
        ...
        assert(params.canCrit and params.criticalChance[1] == 0.10 and params.criticalChance[2] == 0.20 and params.criticalChance[3] == 0.25 and damage == nil)
