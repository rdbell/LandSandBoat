...
describe('Mob call pets spawn cap', function()
    ...
    it('selects owner-assist target, follow, death, or no-op behavior', function()
        assert(xi.mob.callPetAssistAction(false, false, false, false, false) == xi.mob.callPetAssistNone)
        assert(xi.mob.callPetAssistAction(true, true, false, true, false) == xi.mob.callPetAssistTarget)
        assert(xi.mob.callPetAssistAction(true, false, true, false, false) == xi.mob.callPetAssistFollow)
        assert(xi.mob.callPetAssistAction(true, false, false, false, false) == xi.mob.callPetAssistDie)
        assert(xi.mob.callPetAssistAction(true, false, false, false, true) == xi.mob.callPetAssistNone)
        assert(xi.mob.callPetAssistAction(true, false, true, true, true) == xi.mob.callPetAssistNone)
    end)
end)
