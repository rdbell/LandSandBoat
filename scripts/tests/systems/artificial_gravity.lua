require('scripts/actions/mobskills/artificial_gravity')
describe('Artificial Gravity mob skill', function()
    it('uses Light plan and processed Weight power 15', function()
        local skill = require('scripts/actions/mobskills/artificial_gravity')
