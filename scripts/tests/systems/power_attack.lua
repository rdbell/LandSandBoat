require('scripts/actions/mobskills/power_attack')
describe('Power Attack mob skill', function()
    it('uses its H2H physical plan with attack multiplier and damages only after processing', function()
        local atk = require('scripts/actions/mobskills/power_attack')
        ...
        assert(params.fTP[1] == 1 and params.attackMultiplier[1] == 2 and params.damageType == xi.damageType.HAND_TO_HAND and damage == nil)
