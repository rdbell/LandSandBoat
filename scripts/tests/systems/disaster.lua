require('scripts/actions/mobskills/disaster')

describe('Disaster mob skill', function()
    it('uses its TP-scaled physical plan and applies damage only after processing', function()
        local disaster = require('scripts/actions/mobskills/disaster')
        ...
        assert(disaster.onMobSkillCheck({}, {}, {}) == 0)
        assert(disaster.onMobWeaponSkill(mob, target, {}, {}) == 123)
        assert(params.baseDamage == 77 and params.numHits == 1)
        assert(params.fTP[1] == 3.05 and params.fTP[2] == 6.1 and params.fTP[3] == 9.15)
