require('scripts/actions/mobskills/sledgehammer')
describe('Sledgehammer mob skill', function()
    it('uses physical plan and applies status after processing', function()
        local skillmod = require('scripts/actions/mobskills/sledgehammer')
        ...
        assert(damage[1] == 40 and statusParams[3] == xi.effect.PETRIFICATION and statusParams[6] == 60)
    end)
end)
