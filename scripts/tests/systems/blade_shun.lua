require('scripts/actions/mobskills/blade_shun')
describe('Blade Shun mob skill', function()
    it('uses its physical plan and processed damage', function()
        local skill = require('scripts/actions/mobskills/blade_shun')
        ...
        assert(params.numHits == 5 and damage == nil)
