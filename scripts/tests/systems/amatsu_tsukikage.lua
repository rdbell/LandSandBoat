require('scripts/actions/mobskills/amatsu_tsukikage')
describe('Amatsu Tsukikage mob skill', function()
    it('uses its physical plan', function()
        local skill = require('scripts/actions/mobskills/amatsu_tsukikage')
        ...
        assert(params.numHits == 3 and params.shadowBehavior == xi.mobskills.shadowBehavior.NUMSHADOWS_1)
        assert(damage == nil)
