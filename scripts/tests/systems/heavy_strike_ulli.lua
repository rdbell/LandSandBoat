require('scripts/actions/mobskills/heavy_strike_ulli')
describe('Heavy Strike Ulli mob skill', function()
    it('uses physical plan and resets enmity when processed', function()
        local skill = require('scripts/actions/mobskills/heavy_strike_ulli')
        ...
        assert(params.fTP[1] == 3.0 and not reset)
