require('scripts/actions/mobskills/ranged_attack')
describe('Ranged Attack mob skill', function()
    it('uses ranged piercing plan fTP 1.5 skip defenses', function()
        local skill = require('scripts/actions/mobskills/ranged_attack')
        local params = nil
        ...
        assert(params.fTP[1] == 1.5 and params.skipParry and params.attackType == xi.attackType.RANGED)
