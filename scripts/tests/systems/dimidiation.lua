require('scripts/actions/mobskills/dimidiation')

describe('Dimidiation mob skill', function()
    it('uses its two-hit physical plan and applies damage only after processing', function()
        local dimidiation = require('scripts/actions/mobskills/dimidiation')
        ...
        assert(dimidiation.onMobSkillCheck({}, {}, {}) == 0)
        assert(dimidiation.onMobWeaponSkill(mob, target, {}, {}) == 123)
        assert(params.baseDamage == 77 and params.numHits == 2)
        assert(params.fTP[1] == 2.25 and params.fTP[2] == 4.5 and params.fTP[3] == 6.75)
        ...
        assert(params.attackMultiplier[1] == 1.25 and params.attackMultiplier[2] == 1.25 and params.attackMultiplier[3] == 1.25 and damage == nil)
