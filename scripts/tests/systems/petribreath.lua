require('scripts/actions/mobskills/petribreath')

describe('Petribreath mob skill', function()
    it('always allows use and applies fixed Petrification via status', function()
        local skill = require('scripts/actions/mobskills/petribreath')
        ...
        assert(params[3] == xi.effect.PETRIFICATION and params[4] == 1 and params[5] == 0 and params[6] == 120)
        assert(message == 456)
    end)
end)
