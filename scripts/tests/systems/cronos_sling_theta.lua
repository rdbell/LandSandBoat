require('scripts/actions/mobskills/cronos_sling_theta')
describe('Cronos Sling Theta mob skill', function()
    it('admits animationSub 1 and uses physical plan', function()
        local skill = require('scripts/actions/mobskills/cronos_sling_theta')
        ...
        assert(params.fTP[1] == 2.5 and params.shadowBehavior == xi.mobskills.shadowBehavior.NUMSHADOWS_2)
        assert(damage == nil)
