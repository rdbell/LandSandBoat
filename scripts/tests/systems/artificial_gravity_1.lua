require('scripts/actions/mobskills/artificial_gravity_1')
describe('Artificial Gravity 1 mob skill', function()
    it('uses Light plan and processed Weight power 15', function()
        local skill = require('scripts/actions/mobskills/artificial_gravity_1')
        ...
        assert(damage[1] == 80 and effect[1] == xi.effect.WEIGHT and effect[2] == 15 and effect[4] == 60)
    end)
end)
