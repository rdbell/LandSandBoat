require('scripts/actions/mobskills/vorpal_scythe')
describe('Vorpal Scythe mob skill', function()
    it('uses physical plan with TP-scaled crit chance', function()
        local skill = require('scripts/actions/mobskills/vorpal_scythe')
        local params = nil
        ...
        assert(params.canCrit and params.criticalChance[1] == 0.3 and params.criticalChance[3] == 0.9)
