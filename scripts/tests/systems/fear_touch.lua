describe('Fear Touch mob skill', function()
    it('uses its one-hit Slashing critical plan and damages only after processing', function()
        local fearTouch = require('scripts/actions/mobskills/fear_touch')
        ...
        assert(fearTouch.onMobSkillCheck(target, mob, {}) == 0)
        assert(fearTouch.onMobWeaponSkill(mob, target, {}, {}) == 123)
