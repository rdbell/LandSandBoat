require('scripts/actions/mobskills/dirty_claw')

describe('Dirty Claw mob skill', function()
    it('uses its critical physical plan and applies damage only after processing', function()
        local dirtyClaw = require('scripts/actions/mobskills/dirty_claw')
        ...
        assert(dirtyClaw.onMobSkillCheck({}, {}, {}) == 0)
        assert(dirtyClaw.onMobWeaponSkill(mob, target, {}, {}) == 123)
