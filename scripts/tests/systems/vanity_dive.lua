require('scripts/actions/mobskills/vanity_dive')
describe('Vanity Dive mob skill', function()
    it('uses slashing fTP 1.5 plan', function()
        local skill = require('scripts/actions/mobskills/vanity_dive')
