require('scripts/actions/mobskills/uranos_cascade_lambda')
describe('Uranos Cascade Lambda mob skill', function()
    it('requires animationSub 2 and applies bind after processing', function()
        local skill = require('scripts/actions/mobskills/uranos_cascade_lambda')
