require('scripts/actions/mobskills/power_attack_unarmed')
describe('Power Attack Unarmed mob skill', function()
    it('uses its H2H physical plan and damages only after processing', function()
        local atk = require('scripts/actions/mobskills/power_attack_unarmed')
