require('scripts/actions/mobskills/marionette_dice_11')

describe('Marionette Dice 11 mob skill', function()
    it('caps its random HP restore at missing HP and reports the actual restore', function()
        local dice = require('scripts/actions/mobskills/marionette_dice_11')
