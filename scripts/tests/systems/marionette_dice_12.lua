require('scripts/actions/mobskills/marionette_dice_12')

describe('Marionette Dice 12 mob skill', function()
    it('caps its random MP restore at missing MP and reports the actual restore', function()
        local dice = require('scripts/actions/mobskills/marionette_dice_12')
