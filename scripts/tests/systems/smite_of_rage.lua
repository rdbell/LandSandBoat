require('scripts/actions/mobskills/smite_of_rage')
describe('Smite of Rage mob skill', function()
    it('uses physical plan and damages only after processing', function()
        local skillmod = require('scripts/actions/mobskills/smite_of_rage')
