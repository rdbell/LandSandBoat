require('scripts/actions/mobskills/aero_iv')

describe('Aero IV mob skill', function()
    it('uses its Wind magical plan and damages only after processing', function()
        ...
        local aero = require('scripts/actions/mobskills/aero_iv')
        assert(aero.onMobSkillCheck({}, {}, {}) == 0)
        assert(aero.onMobWeaponSkill(mob, target, {}, {}) == 123)
        assert(params.baseDamage == 52 and params.fTP[1] == 8 and params.fTP[2] == 8 and params.fTP[3] == 8)
