require('scripts/actions/mobskills/tachi_kasha')
describe('Tachi Kasha mob skill', function()
    it('uses physical plan with Paralysis on process', function()
        local skill = require('scripts/actions/mobskills/tachi_kasha')
        ...
        assert(params.fTP[1] == 1.56 and params.attackMultiplier[1] == 1.5)
        assert(status[1] == xi.effect.PARALYSIS and status[2] == 25 and status[4] == 60)
