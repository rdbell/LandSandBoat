require('scripts/actions/mobskills/nimble_snap')

describe('Nimble Snap mob skill', function()
    it('uses its three-hit Slashing plan and damages only after processing', function()
        local snap = require('scripts/actions/mobskills/nimble_snap')
        ...
        assert(snap.onMobSkillCheck(target, mob, skill) == 0 and snap.onMobWeaponSkill(mob, target, skill, {}) == 123)
        ...
        snap.onMobWeaponSkill(mob, target, skill, {})
