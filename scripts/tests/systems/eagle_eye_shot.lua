require('scripts/actions/mobskills/eagle_eye_shot')

describe('Eagle Eye Shot mob skill', function()
    it('uses its ranged physical plan and applies damage only after processing', function()
        local eagleEyeShot = require('scripts/actions/mobskills/eagle_eye_shot')
        ...
        assert(params.baseDamage == 77 and params.numHits == 1 and params.fTP[1] == 9 and params.fTP[2] == 9 and params.fTP[3] == 9)
