require('scripts/actions/mobskills/memory_of_wind')

describe('Memory Of Wind mob skill', function()
    it('uses its Wind magical plan and damages only after processing', function()
        local memory = require('scripts/actions/mobskills/memory_of_wind')
        ...
        assert(params.element == xi.element.WIND and params.attackType == xi.attackType.MAGICAL and params.damageType == xi.damageType.WIND and params.shadowBehavior == xi.mobskills.shadowBehavior.WIPE_SHADOWS and damage == nil)
