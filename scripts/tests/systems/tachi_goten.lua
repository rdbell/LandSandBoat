require('scripts/actions/mobskills/tachi_goten')
describe('Tachi Goten mob skill', function()
    it('uses hybrid physical+thunder plan and sums damage', function()
        local skill = require('scripts/actions/mobskills/tachi_goten')
        ...
        assert(params.hybridSkill and params.hybridSkillElement == xi.element.THUNDER and total == 80)
