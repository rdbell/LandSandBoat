require('scripts/actions/mobskills/heavy_strike')
describe('Heavy Strike mob skill', function()
    it('uses physical plan and processed damage', function()
        local skill = require('scripts/actions/mobskills/heavy_strike')
        ...
        assert(params.fTP[1] == 2.5 and damage == nil)
