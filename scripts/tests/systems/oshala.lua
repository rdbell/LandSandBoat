require('scripts/actions/mobskills/oshala')

describe('Oshala mob skill', function()
    it('uses its blunt physical plan and damages only after processing', function()
        local oshala = require('scripts/actions/mobskills/oshala')
        ...
        assert(oshala.onMobSkillCheck(target, mob, {}) == 0 and oshala.onMobWeaponSkill(mob, target, {}, {}) == 123)
        assert(params.baseDamage == 77 and params.numHits == 1)
        assert(params.fTP[1] == 3.95 and params.fTP[2] == 7.89 and params.fTP[3] == 11.84)
        ...
        oshala.onMobWeaponSkill(mob, target, {}, {})
