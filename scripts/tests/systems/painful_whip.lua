require('scripts/actions/mobskills/painful_whip')

describe('Painful Whip mob skill', function()
    it('uses its blunt physical plan with crit and damages only after processing', function()
        local whip = require('scripts/actions/mobskills/painful_whip')
        ...
        assert(whip.onMobSkillCheck(target, mob, {}) == 0 and whip.onMobWeaponSkill(mob, target, {}, {}) == 123)
        assert(params.baseDamage == 77 and params.numHits == 1 and params.fTP[1] == 3 and params.canCrit)
        ...
        whip.onMobWeaponSkill(mob, target, {}, {})
