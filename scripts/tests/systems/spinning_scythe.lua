require('scripts/actions/mobskills/spinning_scythe')
describe('Spinning Scythe mob skill', function()
    it('uses physical plan and damages only after processing', function()
        local skillmod = require('scripts/actions/mobskills/spinning_scythe')
