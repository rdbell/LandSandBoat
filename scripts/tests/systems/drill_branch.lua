require('scripts/actions/mobskills/drill_branch')

describe('Drill Branch mob skill', function()
    it('uses its piercing physical plan and applies damage plus Blindness only after processing', function()
        local drillBranch = require('scripts/actions/mobskills/drill_branch')
