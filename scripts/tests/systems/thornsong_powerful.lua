require('scripts/actions/mobskills/thornsong_powerful')
describe('Thornsong Powerful mob skill', function()
    it('refuses when silenced and applies DAMAGE_SPIKES power 120', function()
        local skill = require('scripts/actions/mobskills/thornsong_powerful')
        ...
        assert(buff[1] == xi.effect.DAMAGE_SPIKES and buff[2] == 120 and buff[4] == 30 and msg == 194)
