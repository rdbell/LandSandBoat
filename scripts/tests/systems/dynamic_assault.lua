require('scripts/actions/mobskills/dynamic_assault')

describe('Dynamic Assault mob skill', function()
    it('uses its physical plan and applies damage only after processing', function()
        local assault = require('scripts/actions/mobskills/dynamic_assault')
        ...
        assert(assault.onMobSkillCheck({}, {}, {}) == 0)
        assert(assault.onMobWeaponSkill(mob, target, {}, {}) == 123)
