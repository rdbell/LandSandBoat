require('scripts/actions/mobskills/memory_of_light')

describe('Memory Of Light mob skill', function()
    it('uses its Light magical plan and damages only after processing', function()
        local memory = require('scripts/actions/mobskills/memory_of_light')
