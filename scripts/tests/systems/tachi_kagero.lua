require('scripts/actions/mobskills/tachi_kagero')
describe('Tachi Kagero mob skill', function()
    it('uses hybrid physical+fire plan and sums damage', function()
        local skill = require('scripts/actions/mobskills/tachi_kagero')
        ...
        assert(params.hybridSkill and params.hybridSkillElement == xi.element.FIRE and total == 80)
