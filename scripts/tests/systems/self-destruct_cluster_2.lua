require('scripts/actions/mobskills/self-destruct_cluster_2')
describe('Self-Destruct Cluster 2 mob skill', function()
    it('uses fire breath fTP 0.5 with final animation sub 6', function()
        local skill = require('scripts/actions/mobskills/self-destruct_cluster_2')
        ...
        local sk = { getMobHP = function() return 400 end, setFinalAnimationSub = function(_, a) anim = a end }
        ...
        assert(params.fTP[1] == 0.5 and params.baseDamage == 400 and anim == 6)
