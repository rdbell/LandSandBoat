require('scripts/actions/mobskills/nether_blast')

describe('Nether Blast mob skill', function()
    it('uses its Dark magical plan and damages only after processing', function()
        local blast = require('scripts/actions/mobskills/nether_blast')
        ...
        assert(blast.onMobSkillCheck(target, mob, skill) == 0 and blast.onMobWeaponSkill(mob, target, skill, {}) == 123)
