require('scripts/actions/mobskills/barbed_crescent')
describe('Barbed Crescent mob skill', function()
    it('uses Slashing plan and processed Accuracy Down', function()
        local skill = require('scripts/actions/mobskills/barbed_crescent')
        ...
        assert(params.fTP[1] == 1.5 and damage == nil and effect == nil)
        xi.mobskills.processDamage = function() return true end
        assert(skill.onMobWeaponSkill(mob, target, {}, {}) == 80)
        xi.mobskills.mobPhysicalMove = physicalMove
        xi.mobskills.processDamage = processDamage
        xi.mobskills.mobStatusEffectMove = statusEffectMove
        assert(damage[1] == 80 and effect[1] == xi.effect.ACCURACY_DOWN and effect[2] == 100 and effect[4] == 180)
    end)
end)
