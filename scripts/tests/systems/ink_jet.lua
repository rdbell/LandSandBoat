describe('Ink Jet mob skill', function()
    it('uses its Dark magical plan and applies Blindness only after processing', function()
        local jet = require('scripts/actions/mobskills/ink_jet')
        ...
        assert(params.baseDamage == 77 and params.fTP[1] == 1.5 and params.fTP[2] == 2 and params.fTP[3] == 2.5 and params.element == xi.element.DARK and params.attackType == xi.attackType.MAGICAL and params.damageType == xi.damageType.DARK and params.shadowBehavior == xi.mobskills.shadowBehavior.IGNORE_SHADOWS and damage == nil and blindness == nil)
