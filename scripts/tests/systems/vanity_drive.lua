require('scripts/actions/mobskills/vanity_drive')
describe('Vanity Drive mob skill', function()
    it('uses slashing three-shadow plan', function()
        local skill = require('scripts/actions/mobskills/vanity_drive')
