require('scripts/actions/mobskills/thunder_break_2129')
describe('Thunder Break 2129 mob skill', function()
    it('uses HIT_DMG primary message and fixed stun duration 4', function()
        local skill = require('scripts/actions/mobskills/thunder_break_2129')
        ...
        assert(params.primaryMessage == xi.msg.basic.HIT_DMG and params.element == xi.element.THUNDER and statusParams == nil)
