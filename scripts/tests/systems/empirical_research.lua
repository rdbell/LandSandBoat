require('scripts/actions/mobskills/empirical_research')

describe('Empirical Research mob skill', function()
    it('uses its magical plan and damages only after processing succeeds', function()
        local research = require('scripts/actions/mobskills/empirical_research')
        ...
        assert(research.onMobSkillCheck({}, {}, {}) == 0)
        assert(research.onMobWeaponSkill(mob, target, {}, {}) == 123)
