require('scripts/actions/mobskills/artificial_gravity_3')
describe('Artificial Gravity 3 mob skill', function()
    it('uses Light plan and processed Weight power 45', function()
        local skill = require('scripts/actions/mobskills/artificial_gravity_3')
        ...
        assert(damage[1] == 80 and effect[1] == xi.effect.WEIGHT and effect[2] == 45 and effect[4] == 60)
    end)
end)
