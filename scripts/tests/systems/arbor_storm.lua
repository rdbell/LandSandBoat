require('scripts/actions/mobskills/arbor_storm')
describe('Arbor Storm mob skill', function()
    it('uses Piercing plan and processed Weight 75/60', function()
        local skill = require('scripts/actions/mobskills/arbor_storm')
        ...
        assert(damage[1] == 90 and effect[1] == xi.effect.WEIGHT and effect[2] == 75 and effect[4] == 60)
    end)
end)
