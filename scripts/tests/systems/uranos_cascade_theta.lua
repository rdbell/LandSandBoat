require('scripts/actions/mobskills/uranos_cascade_theta')
describe('Uranos Cascade Theta mob skill', function()
    it('requires animationSub 1 and applies bind after processing', function()
        local skill = require('scripts/actions/mobskills/uranos_cascade_theta')
        ...
        assert(params.fTP[1] == 1.50 and statusParams == nil)
