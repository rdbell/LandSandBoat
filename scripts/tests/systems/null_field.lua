require('scripts/actions/mobskills/null_field')

describe('Null Field mob skill', function()
    it('uses its Fire magical plan and damages only after processing', function()
        local field = require('scripts/actions/mobskills/null_field')
        ...
        assert(field.onMobSkillCheck(target, mob, skill) == 0 and field.onMobWeaponSkill(mob, target, skill, {}) == 123)
        assert(params.baseDamage == 75 and params.fTP[1] == 4.3 and params.fTP[2] == 4.3 and params.fTP[3] == 4.3)
        ...
        field.onMobWeaponSkill(mob, target, skill, {})
