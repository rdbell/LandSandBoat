require('scripts/actions/mobskills/diamond_dust')

describe('Diamond Dust mob skill', function()
    it('uses its Ice magical plan and damages only after processing', function()
        ...
        local dust = require('scripts/actions/mobskills/diamond_dust')
        assert(dust.onMobSkillCheck({}, {}, {}) == 0)
        assert(dust.onMobWeaponSkill(mob, target, {}, {}) == 123)
