describe('Jump mob skill', function()
    it('uses VIT-scaled fTP and damages only after processing', function()
        local jump = require('scripts/actions/mobskills/jump')
        ...
        assert(jump.onMobSkillCheck(target, mob, {}) == 0 and jump.onMobWeaponSkill(mob, target, {}, {}) == 123)
        ...
        jump.onMobWeaponSkill(mob, target, {}, {})
