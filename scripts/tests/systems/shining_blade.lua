require('scripts/actions/mobskills/shining_blade')
describe('Shining Blade mob skill', function()
    it('emits READIES_WS and uses light magical plan', function()
        local blade = require('scripts/actions/mobskills/shining_blade')
        ...
        assert(msg[1] == xi.msg.basic.READIES_WS and msg[3] == xi.weaponskill.SHINING_BLADE)
        ...
        assert(params.baseDamage == 52 and params.fTP[1] == 1.0 and params.fTP[2] == 2.0 and params.fTP[3] == 2.5 and damage == nil)
