require('scripts/actions/mobskills/heavy_swing')
describe('Heavy Swing mob skill', function()
    it('uses TP-scaled physical plan and processed damage', function()
        local skill = require('scripts/actions/mobskills/heavy_swing')
        ...
        assert(params.fTP[1] == 1.0 and params.fTP[2] == 1.25 and params.fTP[3] == 2.25)
