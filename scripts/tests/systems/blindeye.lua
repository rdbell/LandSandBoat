require('scripts/actions/mobskills/blindeye')
describe('Blindeye mob-skill plan mob skill', function()
    it('uses its physical plan and status when processed', function()
        local skill = require('scripts/actions/mobskills/blindeye')
        ...
        assert(damage[1] == 80)
		assert(effect[1] == xi.effect.BLINDNESS and effect[2] == 30 and effect[4] == 30)
    end)
end)
