require('scripts/actions/mobskills/methane_breath')

describe('Methane Breath mob skill', function()
    it('uses its Fire breath parameters and damages only after processing', function()
        local breath = require('scripts/actions/mobskills/methane_breath')
        ...
        assert(params.percentMultipier == 0.0625 and params.damageCap == 400 and params.bonusDamage == 0)
