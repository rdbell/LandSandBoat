require('scripts/actions/mobskills/august_melee_bow')
describe('August Melee Bow mob skill', function()
    it('uses one-hit plan with HIT_DMG primary message', function()
        local skill = require('scripts/actions/mobskills/august_melee_bow')
