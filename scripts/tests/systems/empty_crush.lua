require('scripts/actions/mobskills/empty_crush')

describe('Empty Crush mob skill', function()
    it('uses its one-hit physical plan and damages only after processing succeeds', function()
        local crush = require('scripts/actions/mobskills/empty_crush')
        ...
        assert(crush.onMobSkillCheck({}, {}, {}) == 0)
        assert(crush.onMobWeaponSkill(mob, target, {}, {}) == 123)
