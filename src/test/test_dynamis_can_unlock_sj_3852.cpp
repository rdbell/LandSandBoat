#include "test_dynamis_can_unlock_sj_3852.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "dynamis CanUnlockSJ 3852 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua formula for dual-wire cross-check (slice 3852 expand residual 2921):
...
// Compact dual-wire pin matching Go pinCanUnlockSJ3852:
...
//   hasSJRestriction ? 1 : 0
// free==inline==pin==pin3807 required for residual expand 3852.
...
// slice 3852 dedicated expand residual 2921; prior dedicated 3807 / 3762 / 3717 / 3672 / 3627 / 3582 / 3538 / 3476 / 3422 / 3151 retained).
//
// Coverage:
//   - has SJ_RESTRICTION → 1; no restriction → 0
//   - free == inline == pin == pin3807 == hasSJRestriction ? 1 : 0
...
auto runDynamisCanUnlockSJ3852SelfTests() -> bool
{
    ...
    // --- Core branches: free == inline == pin == pin3807 == formula ---
    ...
    // free == pin3807 (required dual-wire identity for residual expand).
    ok = expect(CanUnlockSJ(true) == pinCanUnlockSJ3807(true), "free==pin3807 hasSJ=true") && ok;
    ok = expect(CanUnlockSJ(false) == pinCanUnlockSJ3807(false), "free==pin3807 hasSJ=false") && ok;
    ...
    // Dense 2^1 compose: free == inline == pin == pin3807 == formula
    // (and prior 3807 / 3762 / 3717 / 3672 / 3627 / 3582 / 3538 / 3476 / 3422 / 3151 pins).
