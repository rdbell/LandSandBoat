#include "test_campaign_afford_notes_3273.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "campaign afford notes 3273 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanAffordAlliedNotes3273 / C++ capacity:
//   notes >= price
...
// OmegaXI internal/campaign; dedicated slice 3273 expand residual 2946).
//
// Coverage:
//   - free == inline == pin == (notes >= price)
//   - residual 2946 / 3072 / 3226 / 1115 pins still hold
...
auto runCampaignAffordNotes3273SelfTests() -> bool
{
    ...
    // Residual 1115 / 2946 / 3072 / 3226 pins still hold under dual-wire.
