#include "test_attackutils_da_double_damage_3320.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "attackutils ShouldApplyDADoubleDamage 3320 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CheckForDamageMultiplier DOUBLE type double-damage formula for
// dual-wire cross-check (dedicated 3320):
...
// Compact dual-wire pin matching Go pinShouldApplyDADoubleDamage3320 / C++
// capacity:
//   attackType == AttackTypeDouble && rateProcs
// Direct return (QF1001/SA1008 safe).
...
// dedicated slice 3320 expand residual 3120 / prior 3289).
//
// Coverage:
//   - free == inline == pin == (attackType == DOUBLE && rateProcs)
//   - residual poles (1380 / 3249 / prior 3289) still hold
...
auto runAttackutilsDADoubleDamage3320SelfTests() -> bool
{
    ...
    const struct
    {
        ...
        // Classic dual poles / residual 1380+3249+prior 3289 surface.
        ...
        // Residual 1380 / 3249 / prior 3289 pins (labeled).
