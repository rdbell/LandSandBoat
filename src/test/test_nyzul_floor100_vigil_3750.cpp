#include "test_nyzul_floor100_vigil_3750.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "nyzul floor100 vigil 3750 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua vigilWeaponDrop floor-100 gate for dual-wire cross-check
// (slice 3750 dedicated expand residual 2900; prior dedicated 3352 / 3449 / 3502 / 3570 / 3615 / 3660 / 3705):
...
// Compact dual-wire pin matching free function / capacity body (slice 3750).
...
// (Lua vigilWeaponDrop floor-100 guaranteed-drop gate; slice 3750 dedicated
// expand residual 2900; prior dedicated 3352 / 3449 / 3502 / 3570 / 3615 / 3660 / 3705). Formula unchanged.
//
// Coverage:
//   - free == inline == pin (direct return formula)
//   - residual 2900 / 1088 poles still hold (100 grants; non-100 misses)
//   - prior dedicated 3352 / 3449 / 3502 / 3570 / 3615 / 3660 / 3705 pins still hold
...
auto runNyzulFloor100Vigil3750SelfTests() -> bool
{
    ...
    // Residual 2900 / 1088 / prior dedicated 3352 / 3449 / 3502 / 3570 / 3615 / 3660 / 3705 pins still hold.
    ...
    for (const auto& p : poles)
    {
        ...
        const bool pin      = pinShouldDropFloor100VigilWeapons3750(p.floor);
    ...
    for (const auto& e : edges)
    {
        ...
        const bool pin     = pinShouldDropFloor100VigilWeapons3750(e.floor);
    ...
    for (int32 floor = -2; floor <= Floor100 + 5; ++floor)
    {
        ...
        const bool pin     = pinShouldDropFloor100VigilWeapons3750(floor);
    ...
    ok = expect(ShouldDropFloor100VigilWeapons(99) == pinShouldDropFloor100VigilWeapons3750(99),
                "free == pin 99") &&
         ok;
    ok = expect(ShouldDropFloor100VigilWeapons(100) == pinShouldDropFloor100VigilWeapons3705(100),
                "free == prior pin3705 100") &&
         ok;
    ok = expect(ShouldDropFloor100VigilWeapons(99) == pinShouldDropFloor100VigilWeapons3705(99),
                "free == prior pin3705 99") &&
         ok;
    ...
    // Residual 2900 / prior dedicated 3352 / 3449 / 3502 / 3570 / 3615 / 3660 / 3705 still hold under dedicated 3750.
    ok = expect(ShouldDropFloor100VigilWeapons(100) && !ShouldDropFloor100VigilWeapons(99),
                "residual 2900 / prior 3352 / 3449 / 3502 / 3570 / 3615 / 3660 / 3705 pins under 3750") &&
         ok;
