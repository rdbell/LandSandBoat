#include "test_mobtype_can_be_neutral_3306.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "mobtype CanBeNeutral 3306 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CMobEntity::CanBeNeutral type policy for dual-wire cross-check
// (dedicated slice 3306 expand residual 2934 / prior ~3276):
//   !Has(t, Notorious)
...
// Compact dual-wire pin matching Go pinCanBeNeutral3306 / C++ capacity
...
// dedicated slice 3306 expand residual 2934 / prior 3276 / 3223 / 3076 /
// pure 2042/2655).
//
// Coverage:
...
auto runMobtypeCanBeNeutral3306SelfTests() -> bool
{
    ...
    // Residual 2042 / 2655 / 2934 / 3076 / 3223 / 3276 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual poles (slice 2934 / 3076 / 3223 / 3276 / 3306).
