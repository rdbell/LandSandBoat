#include "test_interactionlookup_skip_priority_3410.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "interactionlookup ShouldSkipPrioritySelection 3410 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline interaction_lookup.lua getHighestPriorityActions early-return gate
// for dual-wire cross-check (dedicated 3410):
//   empty || firstIsNumber
...
// Compact dual-wire pin matching Go pinShouldSkipPrioritySelection3410 /
// C++ capacity (formula unchanged from 1094 / 2953 / 3167 / 3246 / 3332):
//   empty || firstIsNumber
...
// OmegaXI internal/interactionlookup; dedicated slice 3410; residual expand
// 2953 / prior 3332 / 3246 / 3167 / pure 1094).
//
// Coverage:
//   - free == inline == pin positive form (empty || firstIsNumber)
//   - residual poles + dense 2^2
//   - residual 2953 / 1094 / prior 3167 / prior 3246 / prior 3332 pins still hold
...
auto runInteractionlookupSkipPriority3410SelfTests() -> bool
{
    ...
    // Residual 1094 / 2953 / prior 3167 / prior 3246 / prior 3332 pins still hold under dedicated dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2953 / 1094 / prior 3167 / prior 3246 / prior 3332 re-pins.
    ...
    // Residual 1094 / 2953 / prior 3167 / prior 3246 / prior 3332 poles still hold under dual-wire.
