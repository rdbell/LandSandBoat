#include "test_universalcontainer_set_item_3288.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "universalcontainer ShouldAllowSetItem 3288 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline SetItem outer gate for dual-wire cross-check (dedicated 3288):
//   slotInRange && !locked
...
// Compact dual-wire pin matching Go pinShouldAllowSetItem3288 / C++ capacity:
//   slotInRange && !locked
// Positive form only (avoid De Morgan compound-not rewrites).
...
// dedicated slice 3288 expand residual 2965 / prior 3248).
//
// Coverage:
//   - free == inline == pin == (slotInRange && !locked)
//   - residual poles (2801 / 2965 / prior 3176 / prior 3248) still hold
...
auto runUniversalcontainerSetItem3288SelfTests() -> bool
{
    ...
    // Residual 2801 / 2965 / prior 3176 / prior 3248 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Classic dual poles / residual 2801+2965+prior 3176+prior 3248 surface.
        ...
        // Residual 2801 / 2965 / prior 3176 / prior 3248 pins (full 2^2 surface, labeled).
