#include "test_trade_bump_items_count_3474.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "trade ShouldBumpItemsCountOnSetEntry 3474 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldBumpItemsCountOnSetEntry3474 / C++ capacity:
//   slotInRange
...
// dedicated slice 3474 expand residual 2997; prior dedicated 3420 / 3372).
//
// Coverage:
//   - free == inline == pin == slotInRange (identity)
//   - residual 2812 / 2997 / prior dedicated 3372 / 3420 pins still hold
...
auto runTradeBumpItemsCount3474SelfTests() -> bool
{
    ...
    // Residual 2812 / 2997 / prior dedicated 3372 / 3420 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2997 / 2812 / prior 3372 / 3420 poles (full 2^1 surface).
