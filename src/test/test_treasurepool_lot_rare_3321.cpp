#include "test_treasurepool_lot_rare_3321.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "treasurepool CanLotRareItem 3321 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline lotItem rare-owned formula for dual-wire cross-check (dedicated 3321):
...
// Compact dual-wire pin matching Go pinCanLotRareItem3321 / positive form:
...
// internal/treasurepool; dedicated slice 3321 expand residual 2998;
// prior dedicated ~3291).
//
// Coverage:
//   - free == inline == pin == (!itemIsRare || !alreadyHasItem)  [positive form]
//   - residual 1367 / 2998 / prior 3260 / 3291 pins still hold
...
auto runTreasurepoolLotRare3321SelfTests() -> bool
{
    ...
    // Residual 1367 / 2998 / prior 3260 / 3291 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Prior dedicated 3291 poles still hold.
        { true, true, false, "prior 3291 rare owned reject" },
        { true, false, true, "prior 3291 rare unowned accept" },
        { false, true, true, "prior 3291 non-rare has accept" },
        { false, false, true, "prior 3291 non-rare unowned accept" },
