#include "test_garrison_fail_by_death_3461.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "garrison fail-by-death 3461 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// prior dedicated expand 3330 / prior dedicated expand 3406 / dedicated 3461):
...
// Compact dual-wire pin matching Go pinShouldFailByDeath3461:
//   allNPCsDead || allPlayersDead
...
// (Lua xi.garrison BATTLE state fail-by-death gate; dedicated slice 3461;
...
//   - residual 2870 / prior dedicated 3073 / prior dedicated expand 3236 /
//     prior dedicated expand 3330 / prior dedicated expand 3406 pins still hold
...
auto runGarrisonFailByDeath3461SelfTests() -> bool
{
    ...
    // Residual 2870 / prior dedicated 3073 / prior dedicated expand 3236 /
    // prior dedicated expand 3330 / prior dedicated expand 3406 pins.
    ...
    // Residual 2870 / prior dedicated 3073 / prior dedicated expand 3236 /
    // prior dedicated expand 3330 / prior dedicated expand 3406 still hold.
    ok = expect(!ShouldFailByDeath(false, false) && ShouldFailByDeath(true, false) &&
                ...
                "residual 2870/3073/3236/3330/3406 wipe gate pins under 3461") &&
         ok;
    ...
    ok = expect(ShouldFailByDeath(false, false) == pinShouldFailByDeath3406(false, false),
                "prior 3406 pin neither dead still holds under 3461") &&
         ok;
    ok = expect(ShouldFailByDeath(true, false) == pinShouldFailByDeath3406(true, false),
                "prior 3406 pin npcs dead still holds under 3461") &&
         ok;
    ok = expect(ShouldFailByDeath(false, true) == pinShouldFailByDeath3406(false, true),
                "prior 3406 pin players dead still holds under 3461") &&
         ok;
    ok = expect(ShouldFailByDeath(true, true) == pinShouldFailByDeath3406(true, true),
                "prior 3406 pin both dead still holds under 3461") &&
         ok;

    // Residual AllNPCsDead compose (2870 sibling) still holds under 3461.
