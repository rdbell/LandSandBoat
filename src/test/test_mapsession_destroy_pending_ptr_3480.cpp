#include "test_mapsession_destroy_pending_ptr_3480.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "mapsession ShouldDestroyPendingByPointer 3480 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline MapSessionContainer::destroyPendingSession(MapSession*) gate for
// dual-wire cross-check (dedicated slice 3480):
...
// Compact dual-wire pin matching Go pinShouldDestroyPendingByPointer3480 /
...
// (found && pointerMatches; dedicated slice 3480 expand residual 3056 /
// pure 2787; prior dedicated 3426 / 3376 retained).
//
// Coverage:
//   - free == inline == pin == (found && pointerMatches)
//   - residual 2787 / 3056 / prior dedicated 3376 / 3426 pins still hold
...
auto runMapsessionDestroyPendingPtr3480SelfTests() -> bool
{
    ...
    // Residual 2787 / 3056 / prior dedicated 3376 / 3426 pins still hold under dual-wire.
    ok = expect(ShouldDestroyPendingByPointer(true, true), "residual 3426/3376/3056/2787: found match destroys") && ok;
    ok = expect(!ShouldDestroyPendingByPointer(true, false), "residual 3426/3376/3056/2787: found mismatch rejects") && ok;
    ok = expect(!ShouldDestroyPendingByPointer(false, false), "residual 3426/3376/3056/2787: missing rejects") && ok;
    ok = expect(!ShouldDestroyPendingByPointer(false, true), "residual 3426/3376/3056/2787: missing ignores match flag") && ok;
    ...
    // Residual independence (2787 / 3056 / 3066 / 3376 / 3426): pointer path needs identity;
