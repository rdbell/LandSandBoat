#include "test_trade_bump_items_count_3372.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "trade ShouldBumpItemsCountOnSetEntry 3372 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldBumpItemsCountOnSetEntry3372 / C++ capacity:
//   slotInRange
...
// dedicated slice 3372 expand residual 2997).
//
// Coverage:
//   - free == inline == pin == slotInRange (identity)
//   - residual 2812 / 2997 pins still hold
...
auto runTradeBumpItemsCount3372SelfTests() -> bool
{
    ...
    // Residual 2812 / 2997 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2997 / 2812 poles (full 2^1 surface).
