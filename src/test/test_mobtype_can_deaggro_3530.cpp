#include "test_mobtype_can_deaggro_3530.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "mobtype CanDeaggro 3530 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CMobEntity::CanDeaggro type policy for dual-wire cross-check
// (dedicated slice 3530 expand residual 2919 / prior dedicated 3471 / 3417 / 3338 / 3063):
...
// Compact dual-wire pin matching Go pinCanDeaggro3530 / C++ capacity
...
// dedicated slice 3530 expand residual 2919 / prior dedicated 3471 / 3417 /
// 3338 / 3063 / pure 2042/2655).
//
// Coverage:
...
//   - prior dedicated suite 3471 remains independent
...
auto runMobtypeCanDeaggro3530SelfTests() -> bool
{
    ...
    // Residual 2042 / 2655 / 2919 / 3063 / 3338 / 3417 / 3471 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual poles (slice 2919 / 3063 / 3338 / 3417 / 3471 / 3530).
