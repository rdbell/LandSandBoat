#include "test_spell_return_zero_no_mp_cost_3454.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "spell ShouldReturnZeroNoMPCost 3454 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CalculateSpellCost hasMPCost gate for dual-wire cross-check
// (dedicated slice 3454 expand residual 2969):
//   !hasMPCost
...
// Compact dual-wire pin matching Go pinShouldReturnZeroNoMPCost3454 /
// C++ capacity:
//   !hasMPCost
...
// (!hasMPCost; dedicated slice 3454 expand residual 2969 / prior dedicated
// 3402 / prior dedicated 3183 / pure 2104).
//
// Coverage:
//   - free == inline == pin == !hasMPCost
//   - residual 2104 / 2969 pins still hold
//   - prior dedicated 3183 poles still hold
//   - prior dedicated 3402 poles still hold
...
auto runSpellReturnZeroNoMPCost3454SelfTests() -> bool
{
    ...
    // Residual 2104 / 2969 / prior dedicated 3183 / prior dedicated 3402 pins
    ...
    ok = expect(ShouldReturnZeroNoMPCost(false), "prior dedicated 3402: no MP cost returns zero") && ok;
    ok = expect(!ShouldReturnZeroNoMPCost(true), "prior dedicated 3402: has MP cost proceeds") && ok;
    ...
    // Residual independence (2104 / 2964 / 2969 / 3183 / 3402): null zero and
