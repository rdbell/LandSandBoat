#include "test_mobtype_can_deaggro_3417.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "mobtype CanDeaggro 3417 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CMobEntity::CanDeaggro type policy for dual-wire cross-check
// (dedicated slice 3417 expand residual 2919 / prior dedicated 3338 / 3063):
...
// Compact dual-wire pin matching Go pinCanDeaggro3417 / C++ capacity
...
auto runMobtypeCanDeaggro3417SelfTests() -> bool
{
    ...
    // Residual 2042 / 2655 / 2919 / 3063 / 3338 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual poles (slice 2919 / 3063 / 3338 / 3417).
