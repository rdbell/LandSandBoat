#include "test_ambuscade_start_exit_3382.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "ambuscade start-exit 3382 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onInstanceComplete / onInstanceFailure formula for dual-wire
// checks (slice 3382): player:startEvent(10001) is always called for every char.
...
// Compact dual-wire pin matching C++ capacity formula / Go pinShouldStartExitEvent3382:
//   return true
...
// OmegaXI internal/ambuscade; dedicated slice 3382 expand residual 2917; prior
...
//   - residual 2917 / 3109 / 1089 pins still hold
...
auto runAmbuscadeStartExit3382SelfTests() -> bool
{
    ...
    // Residual constant / 1089 / 2917 / prior dedicated 3109 pins still hold.
    ...
    // Residual 2917 / prior dedicated 3109 still hold under dedicated 3382.
    ok = expect(ShouldStartExitEvent(), "residual 2917/3109 pins under 3382") && ok;
