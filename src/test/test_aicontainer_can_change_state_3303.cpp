#include "test_aicontainer_can_change_state_3303.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aicontainer CanChangeState 3303 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAIContainer::CanChangeState for dual-wire cross-check (dedicated 3303
// expand residual 2952; prior dedicated 3272):
...
// Compact dual-wire pin matching Go pinCanChangeState3303 / C++ capacity
// OR form (formula unchanged from 1189 / 2952 / 3272). Direct OR (not if/else):
//   !hasCurrentState || currentCanChange
...
// dedicated slice 3303 expand residual 2952; prior dedicated 3272; pure 1189).
//
// Coverage:
...
auto runAicontainerCanChangeState3303SelfTests() -> bool
{
    ...
    const struct
    {
        ...
        // Prior dedicated 3272 re-pins.
        { false, false, true, "prior 3272 idle ignores currentCanChange false" },
        { false, true, true, "prior 3272 idle ignores currentCanChange true" },
        { true, false, false, "prior 3272 active blocks" },
        { true, true, true, "prior 3272 active allows" },
    };
    ...
    // Residual independence (1189 / 2952 / 3272 / 2947 / 3222 left alone):
