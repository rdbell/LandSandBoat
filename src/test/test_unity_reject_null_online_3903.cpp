#include "test_unity_reject_null_online_3903.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "unitychat ShouldRejectNullOnlineMember 3903 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline AddOnlineMember / DelOnlineMember null-PChar gate for dual-wire
// cross-check (slice 3903 dedicated expand residual 3075; prior dedicated
// 3858 / 3813 / 3768 / 3723 / 3678 / 3633 / 3588 / 3544 / 3487 / 3436 / 3386):
//   charNull
...
// Compact dual-wire pin matching free function / capacity body (slice 3903).
// Direct return only — same formula as production ShouldRejectNullOnlineMember.
// free == inline == pin == pin3858.
auto pinShouldRejectNullOnlineMember3903(const bool charNull) -> bool
{
    return charNull;
}

// Prior dedicated 3858 pin form retained for free == prior pin cross-check.
...
// slice 3903 dedicated expand residual 3075; prior dedicated 3858 / 3813 / 3768 / 3723 / 3678 / 3633 /
// 3588 / 3544 / 3487 / 3436 / 3386 retained). Formula unchanged.
//
// Coverage:
//   - free == inline == pin == pin3858 (direct return formula)
//   - residual 1356 / 3075 pins still hold
//   - prior 3386 / 3436 / 3487 / 3544 / 3588 / 3633 / 3678 / 3723 / 3768 / 3813 / 3858 dedicated poles still hold
//   - dense 2¹
...
//     test_unity_reject_null_online_3813 / test_unity_reject_null_online_3858
...
auto runUnityRejectNullOnline3903SelfTests() -> bool
{
    ...
    ok = expect(pinShouldRejectNullOnlineMember3858(true), "prior dedicated 3858 null rejects") && ok;
    ok = expect(!pinShouldRejectNullOnlineMember3858(false), "prior dedicated 3858 non-null proceeds") && ok;
    ...
    const struct
    {
        ...
        // Prior dedicated 3858 poles still hold.
        { true, true, "prior dedicated 3858 null rejects" },
        { false, false, "prior dedicated 3858 non-null proceeds" },
    ...
    for (const auto& c : cases)
    {
        ...
        const bool pin     = pinShouldRejectNullOnlineMember3903(c.charNull);
        const bool pin3858 = pinShouldRejectNullOnlineMember3858(c.charNull);
        ...
        ok = expect(got == pin3858, "ShouldRejectNullOnlineMember == pin3858") && ok;
        ...
        ok = expect(got == pinShouldRejectNullOnlineMember3768(c.charNull),
                    "free == prior pin 3768") &&
             ok;
        ok = expect(got == pinShouldRejectNullOnlineMember3813(c.charNull),
                    "free == prior pin 3813") &&
             ok;
    }
    ...
    for (const bool charNull : { false, true })
    {
        ...
        const bool pin     = pinShouldRejectNullOnlineMember3903(charNull);
        const bool pin3858 = pinShouldRejectNullOnlineMember3858(charNull);

        ok = expect(got == want, "compose free == pin formula") && ok;
        ok = expect(got == inlineF, "compose free == inline") && ok;
        ok = expect(got == pin, "compose free == pin 3903") && ok;
        ok = expect(got == pin3858, "compose free == pin3858") && ok;
    ...
    for (const auto& h : hosts)
    {
        ...
        const bool pin     = pinShouldRejectNullOnlineMember3903(h.charNull);
        const bool pin3858 = pinShouldRejectNullOnlineMember3858(h.charNull);
        ...
        ok                 = expect(reject == pin3858, "host compose free == pin3858") && ok;
        ...
        ok = expect(reject == pinShouldRejectNullOnlineMember3768(h.charNull),
             ...
             ok;
        ok = expect(reject == pinShouldRejectNullOnlineMember3813(h.charNull),
                    "host compose free == prior pin 3813") &&
             ok;
    ...
    for (const bool charNull : { false, true })
    {
        ...
        ok              = expect(got == inlineShouldRejectNullOnlineMember(charNull),
             ...
             ok;
        ok = expect(got == pinShouldRejectNullOnlineMember3903(charNull),
                    "host inject free == pin 3903") &&
             ok;
        ok = expect(got == pinShouldRejectNullOnlineMember3858(charNull),
                    "host inject free == prior pin 3858") &&
             ok;
        ok = expect(got == pinShouldRejectNullOnlineMember3813(charNull),
