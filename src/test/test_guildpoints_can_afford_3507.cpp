#include "test_guildpoints_can_afford_3507.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "guildpoints CanAfford 3507 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua guild_points getCurrency gate for dual-wire cross-check
// (dedicated 3507 expand residual 2944; prior 3458 / 3404 / 3368 / 3221):
//   currency >= cost
...
// Compact dual-wire pin matching Go pinCanAfford3507 / C++ capacity:
//   currency >= cost
...
// internal/guildpoints; dedicated slice 3507 expand residual 2944;
// prior dedicated 3458 / 3404 / 3368 / 3221 retained).
//
// Coverage:
//   - free == inline == pin == (currency >= cost)
//   - residual 2944 / 3458 / 3404 / 3368 / 3221 / 1016 pins still hold
...
auto runGuildpointsCanAfford3507SelfTests() -> bool
{
    ...
    // Residual 2944 / 3458 / 3404 / 3368 / 3221 / 1016 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2944 / 3458 / 3404 / 3368 / 3221 poles.
