#include "test_command_reject_empty_line_3362.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "command ShouldRejectEmptyCommandLine 3362 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline ParseCommandLine empty-line gate for dual-wire cross-check
// (dedicated 3362 expand residual 2836 / prior 3005):
//   viewEmptyAfterTrim
...
// Compact dual-wire pin matching Go pinShouldRejectEmptyCommandLine3362 /
// C++ capacity identity form (formula unchanged from 2836 / 3005).
...
// (viewEmptyAfterTrim identity; OmegaXI internal/command; dedicated slice 3362
// expand residual 2836 / prior dual-wire 3005).
//
// Coverage:
//   - free == inline == pin identity form
//   - poles: empty after trim rejects; non-empty proceeds
//   - residual 2836 / 3005 pins still hold
...
auto runCommandRejectEmptyLine3362SelfTests() -> bool
{
    ...
    // Residual 2836 / prior dual-wire 3005 pins still hold under dedicated expand.
    ...
    // Residual independence (2792 / 2836 / 2940 / 2982 / 2990 / 3005 / 3011 / 3161 / 3185 / 3205):
    // empty-line reject is distinct from null-char / empty-name / permission / audit.
