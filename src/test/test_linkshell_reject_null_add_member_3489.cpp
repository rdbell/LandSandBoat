#include "test_linkshell_reject_null_add_member_3489.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "linkshell ShouldRejectNullAddMember 3489 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldRejectNullAddMember3489 / C++
...
// (charNull identity; OmegaXI internal/linkshell; dedicated slice 3489;
// residual expand 2929 / pure 1354; prior dedicated expand 3195).
//
// Coverage:
//   - free == inline == pin identity form
//   - poles: null rejects; non-null allows
//   - residual 2929 / 1354 / prior dedicated 3195 pins still hold
//   - host-style inject + residual independence (2958 / 3079)
//   - prior dedicated 3195 independence (RETAINED)
auto runLinkshellRejectNullAddMember3489SelfTests() -> bool
{
    ...
    // Residual 1354 / 2929 / prior dedicated 3195 pins still hold under
    ...
    const struct
    {
        ...
        // Residual 2929 / 1354 / prior dedicated 3195 re-pins.
    ...
    // Residual independence (1354 / 2929 / 3195 / 2958 / 3079):
    // AddMember null reject is distinct from duplicate-add and online-null gates.
    // Prior dedicated 3195 independence (RETAINED under this expand).
