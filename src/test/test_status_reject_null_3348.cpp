#include "test_status_reject_null_3348.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "status effect ShouldRejectNullStatusEffect 3348 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline AddStatusEffect null-effect formula for dual-wire cross-check
// (dedicated slice 3348 expand residual 3080):
//   isNull
...
// Compact dual-wire pin matching Go pinShouldRejectNullStatusEffect3348 /
// C++ capacity identity form (formula unchanged from 1371 / 3080):
//   isNull
...
// (isNull identity; OmegaXI internal/statuseffect; dedicated slice 3348
// expand residual 3080 / pure 1371).
//
// Coverage:
...
auto runStatusRejectNull3348SelfTests() -> bool
{
    ...
    // Residual independence (1371 / 2932 / 3080; 3049 / 3069 / 3113 / 3135 left alone):
