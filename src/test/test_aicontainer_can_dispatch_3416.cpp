#include "test_aicontainer_can_dispatch_3416.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aicontainer CanDispatch 3416 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAIContainer public controller-forward presence gate for dual-wire
// cross-check (dedicated 3416 expand residual 2947; prior dedicated 3369 /
// 3222):
//   hasController
...
// Compact dual-wire pin matching Go pinCanDispatch3416 / C++ capacity
// identity form (formula unchanged from 1189 / 2947 / 3222 / 3369). Direct
// return of hasController (not if/else):
//   hasController
...
// (hasController identity; OmegaXI internal/aicontainer; dedicated slice 3416
// expand residual 2947; prior dedicated 3369 / 3222; pure 1189).
//
// Coverage:
...
auto runAicontainerCanDispatch3416SelfTests() -> bool
{
    ...
    // Residual independence (1189 / 2947 / 3222 / 3369 / 2952 / 3272 / 3303 left alone):
