#include "test_petutils_can_attack_target_3298.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "petutils CanAttackTarget 3298 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline AttackTarget null-preflight for dual-wire cross-check (dedicated 3298
// expand residual 3071; prior dedicated 3269):
...
// Compact dual-wire pin matching Go pinCanAttackTarget3298 / C++ capacity:
//   hasMaster && hasPet && hasTarget
...
// dedicated slice 3298 expand residual 3071; prior dedicated 3269; pure 1627).
//
// Coverage:
