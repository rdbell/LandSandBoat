#include "test_extravaganza_can_afford_cipher_3322.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "extravaganza CanAffordCipher 3322 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua shadowEraFinish notes gate for dual-wire cross-check
// (dedicated 3322 expand residual 2881; prior 3292):
//   notes >= 1000
...
// Compact dual-wire pin matching Go pinCanAffordCipher3322:
...
// internal/extravaganza; dedicated slice 3322 expand residual 2881;
// prior dedicated 3292 / 3262 / 3153 retained).
//
// Coverage:
//   - free == inline == pin == notes >= CipherPurchaseNotes
//   - CipherPurchaseNotes == 1000 pin
//   - residual 2881 / 3292 / 3262 / 3153 / 0949 pins still hold
...
auto runExtravaganzaCanAffordCipher3322SelfTests() -> bool
{
    ...
    // Residual 2881 / 3292 / 3262 / 3153 / 0949 CanAffordCipher pins still hold under dual-wire.
