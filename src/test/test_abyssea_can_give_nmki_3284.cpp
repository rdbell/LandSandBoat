#include "test_abyssea_can_give_nmki_3284.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "abyssea CanGiveAtmaNMKI 3284 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua giveNMDrops atma-path formula for dual-wire checks (slice 3284):
...
// Compact dual-wire pin matching Go pinCanGiveAtmaNMKI3284 / C++ capacity
...
// internal/abyssea; dedicated slice 3284 expand residual 2861 /
...
//   - residual 1041 / 2861 / prior 3089 / prior 3238 pins still hold
auto runAbysseaCanGiveNMKI3284SelfTests() -> bool
{
    ...
    // Residual constant / 1041 / 2861 / 3089 / 3238 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2861 / 3089 / 3238 atma poles.
