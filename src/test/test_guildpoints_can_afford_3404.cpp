#include "test_guildpoints_can_afford_3404.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "guildpoints CanAfford 3404 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua guild_points getCurrency gate for dual-wire cross-check
// (dedicated 3404 expand residual 2944; prior 3368 / 3221):
//   currency >= cost
...
// Compact dual-wire pin matching Go pinCanAfford3404 / C++ capacity:
//   currency >= cost
...
// internal/guildpoints; dedicated slice 3404 expand residual 2944;
// prior dedicated 3368 / 3221 retained).
//
// Coverage:
//   - free == inline == pin == (currency >= cost)
//   - residual 2944 / 3368 / 3221 / 1016 pins still hold
...
auto runGuildpointsCanAfford3404SelfTests() -> bool
{
    ...
    // Residual 2944 / 3368 / 3221 / 1016 pins still hold under dual-wire.
