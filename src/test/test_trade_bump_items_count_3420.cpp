#include "test_trade_bump_items_count_3420.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "trade ShouldBumpItemsCountOnSetEntry 3420 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldBumpItemsCountOnSetEntry3420 / C++ capacity:
//   slotInRange
...
// dedicated slice 3420 expand residual 2997; prior dedicated 3372).
//
// Coverage:
//   - free == inline == pin == slotInRange (identity)
//   - residual 2812 / 2997 / prior dedicated 3372 pins still hold
...
auto runTradeBumpItemsCount3420SelfTests() -> bool
{
    ...
    // Residual 2812 / 2997 / prior dedicated 3372 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2997 / 2812 / prior 3372 poles (full 2^1 surface).
