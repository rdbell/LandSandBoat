#include "test_besieged_afford_sanction_3418.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "besieged CanAffordSanction 3418 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onEventFinish sanctionCost for dual-wire cross-check (slice 3418):
//   sanctionCost = 100
...
// Compact dual-wire pin matching Go pinCanAffordSanction3418 / C++ capacity
// (direct return form):
//   imperialStanding >= SanctionAffordCost(option)
...
// internal/besieged; dedicated slice 3418 expand residual 2945 —
// formula unchanged; prior dedicated ~3307).
//
// Coverage:
//   - free == inline == pin == (standing >= SanctionAffordCost(option))
//   - residual 1120 / 2945 / 3093 / 3227 / 3277 / 3307 pins still hold
...
auto runBesiegedAffordSanction3418SelfTests() -> bool
{
    ...
    // Residual constant / 1120 / 2945 / 3093 / 3227 / 3277 / 3307 pins still hold under dual-wire.
