#include "test_mobtype_can_be_neutral_3276.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "mobtype CanBeNeutral 3276 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CMobEntity::CanBeNeutral type policy for dual-wire cross-check
// (dedicated slice 3276 expand residual 2934 / prior ~3223):
//   !Has(t, Notorious)
...
// Compact dual-wire pin matching Go pinCanBeNeutral3276 / C++ capacity
...
// dedicated slice 3276 expand residual 2934 / prior 3223 / 3076 / pure
// 2042/2655).
//
// Coverage:
...
auto runMobtypeCanBeNeutral3276SelfTests() -> bool
{
    ...
    // Residual 2042 / 2655 / 2934 / 3076 / 3223 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual poles (slice 2934 / 3076 / 3223 / 3276).
