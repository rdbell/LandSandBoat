#include "test_interactionlookup_skip_priority_3509.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "interactionlookup ShouldSkipPrioritySelection 3509 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline interaction_lookup.lua getHighestPriorityActions early-return gate
// for dual-wire cross-check (dedicated 3509):
//   empty || firstIsNumber
...
// Compact dual-wire pin matching Go pinShouldSkipPrioritySelection3509 /
// C++ capacity (formula unchanged from 1094 / 2953 / 3167 / 3246 / 3332 / 3410 / 3464):
//   empty || firstIsNumber
...
// OmegaXI internal/interactionlookup; dedicated slice 3509; residual expand
// 2953 / prior 3464 / 3410 / 3332 / 3246 / 3167 / pure 1094).
//
// Coverage:
//   - free == inline == pin positive form (empty || firstIsNumber)
//   - residual poles + dense 2^2
//   - residual 2953 / 1094 / prior 3167 / prior 3246 / prior 3332 / prior 3410 / prior 3464 pins still hold
...
auto runInteractionlookupSkipPriority3509SelfTests() -> bool
{
    ...
    // Residual 1094 / 2953 / prior 3167 / prior 3246 / prior 3332 / prior 3410 / prior 3464 pins still hold under dedicated dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2953 / 1094 / prior 3167 / prior 3246 / prior 3332 / prior 3410 / prior 3464 re-pins.
        ...
        { true, false, true, "prior 3464 empty → skip" },
        { false, true, true, "prior 3464 firstIsNumber → skip" },
        { true, true, true, "prior 3464 both → skip" },
        { false, false, false, "prior 3464 normal → no skip" },
    };
    ...
    // Residual 1094 / 2953 / prior 3167 / prior 3246 / prior 3332 / prior 3410 / prior 3464 poles still hold under dual-wire.
