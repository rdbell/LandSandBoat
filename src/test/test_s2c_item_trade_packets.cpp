...
auto testLayout() -> bool
{
    ...
    ok      = expectEqualUInt(tradeListPacketDataSize, 34, "sizeof(ITEM_TRADE_LIST::PacketData)") && ok;
    ok      = expectEqualUInt(tradeListUnroundedPacketSize, 38, "ITEM_TRADE_LIST unrounded packet size") && ok;
