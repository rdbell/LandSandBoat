#include "test_assault_issue_tag_3388.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "assault issue tag 3388 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onRytaalEventFinish tagStock gate for dual-wire cross-check
// (dedicated 3388 expand residual 2867):
//   tagStock > 0
...
// Compact dual-wire pin matching Go pinCanIssueTagFromStock3388:
//   tagStock > 0
...
// internal/assault; dedicated slice 3388 expand residual 2867 / pure 1100 —
// formula unchanged).
//
// Coverage:
...
auto runAssaultIssueTag3388SelfTests() -> bool
{
    ...
    // Residual 1100 / 2867 / 3145 / 3258 stock poles still hold.
