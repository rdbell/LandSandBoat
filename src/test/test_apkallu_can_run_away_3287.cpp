#include "test_apkallu_can_run_away_3287.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "apkallu can run away 3287 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanRunAway3287:
...
// dedicated slice 3287 expand residual 2880 / prior dedicated ~3245 —
// formula unchanged).
//
// Coverage:
...
//   - residual 0925 / 2880 / prior 3149 / prior 3245 pins still hold
auto runApkalluCanRunAway3287SelfTests() -> bool
{
    ...
    // Residual 0925 / 2880 / prior 3149 / prior 3245 CanRunAway pins still
    // hold under dual-wire (positive pin form for eligible poles).
    ...
    // Prior dedicated 3149 / 3245 independence: free still matches prior pins.
    for (int32 hate = -20; hate <= 120; ++hate)
    {
