#include "test_guildpoints_can_afford_3221.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "guildpoints CanAfford 3221 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanAfford3221 / C++ capacity:
//   currency >= cost
...
// internal/guildpoints; dedicated slice 3221 expand residual 2944).
//
// Coverage:
//   - free == inline == pin == (currency >= cost)
//   - residual 2944 / 1016 pins still hold
...
auto runGuildpointsCanAfford3221SelfTests() -> bool
{
    ...
    // Residual 2944 / 1016 pins still hold under dual-wire.
