#include "test_command_permission_3293.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "command ShouldAllowCommandPermission 3293 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CCommandHandler::call permission gate for dual-wire cross-check (dedicated 3293):
...
// Compact dual-wire pin matching Go pinShouldAllowCommandPermission3293 / C++ capacity
// positive form (formula unchanged from 2792 / 2940 / 3263):
...
// dedicated slice 3293; residual expand 2940 / pure 2792; prior dedicated expand 3263).
//
// Coverage:
//   - free == inline == pin positive form
//   - poles: equal / under / over; signed permission edge; high gm vs mid perm
//   - residual 2940 / 2792 / 3263 pins still hold
...
auto runCommandPermission3293SelfTests() -> bool
{
    ...
    // Residual 2792 / 2940 / 3263 pins still hold under dedicated dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2940 / 2792 / 3263 re-pins.
    ...
    // Residual independence (2792 / 2940 / 2982 / 2990 / 3005 / 3011 / 3161 / 3185 / 3205 / 3263):
