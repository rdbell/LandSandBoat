#include "test_aicontainer_can_dispatch_3531.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aicontainer CanDispatch 3531 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAIContainer public controller-forward presence gate for dual-wire
// cross-check (dedicated 3531 expand residual 2947; prior dedicated 3470 /
// 3416 / 3369 / 3222):
//   hasController
...
// Compact dual-wire pin matching Go pinCanDispatch3531 / C++ capacity
// identity form (formula unchanged from 1189 / 2947 / 3222 / 3369 / 3416 / 3470).
...
// (hasController identity; OmegaXI internal/aicontainer; dedicated slice 3531
// expand residual 2947; prior dedicated 3470 / 3416 / 3369 / 3222; pure 1189).
//
// Coverage:
...
auto runAicontainerCanDispatch3531SelfTests() -> bool
{
    ...
    const struct
    {
        ...
        // Prior dedicated 3470 re-pins.
        { false, false, "prior 3470 no controller rejects" },
        { true, true, "prior 3470 controller present accepts" },
    };
    ...
    // Residual independence (1189 / 2947 / 3222 / 3369 / 3416 / 3470 / 2952 / 3272 / 3303 left alone):
