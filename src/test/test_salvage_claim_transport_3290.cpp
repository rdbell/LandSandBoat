#include "test_salvage_claim_transport_3290.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "salvage claim transport 3290 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanClaimTransport3290:
...
// slice 3290 dedicated dual-wire expand residual 2871).
//
// Coverage:
...
//   - residual 0977 / 1083 / 2871 / 3085 / 3259 pins still hold
auto runSalvageClaimTransport3290SelfTests() -> bool
{
    ...
    // Residual 0977 / 1083 / 2871 / 3085 / 3259 pins still hold under dual-wire.
