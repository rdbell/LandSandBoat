#include "test_battlefield_under_capacity_3302.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "battlefield ShouldAcceptPCUnderCapacity 3302 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldAcceptPCUnderCapacity3302 /
...
// 3302; residual expand 2930 / prior dedicated 3271 / pure 1361).
//
// Coverage:
//   - free == inline == pin strict less-than form
//   - poles: under / at / over capacity; zero max; unit; uint8 extremes
//   - residual 2930 / 1361 / prior 3271 pins still hold
...
auto runBattlefieldUnderCapacity3302SelfTests() -> bool
{
    ...
    // Residual 1361 / 2930 / prior 3271 pins still hold under dedicated dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2930 / 1361 / prior 3271 re-pins
        ...
        { 5, 6, true, "prior 3271 one slot left accepts" },
        { 7, 6, false, "prior 3271 over cap rejects" },
    };
    ...
    // Residual independence (1361 / 2930 / 3271 / 3198 / 3216 / 3140 left alone):
