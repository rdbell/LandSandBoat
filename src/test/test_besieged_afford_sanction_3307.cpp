#include "test_besieged_afford_sanction_3307.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "besieged CanAffordSanction 3307 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onEventFinish sanctionCost for dual-wire cross-check (slice 3307):
//   sanctionCost = 100
...
// Compact dual-wire pin matching Go pinCanAffordSanction3307 / C++ capacity
// (direct return form):
//   imperialStanding >= SanctionAffordCost(option)
...
// internal/besieged; dedicated slice 3307 expand residual 2945 —
// formula unchanged; prior dedicated ~3277).
//
// Coverage:
//   - free == inline == pin == (standing >= SanctionAffordCost(option))
//   - residual 1120 / 2945 / 3093 / 3227 / 3277 pins still hold
...
auto runBesiegedAffordSanction3307SelfTests() -> bool
{
    ...
    // Residual constant / 1120 / 2945 / 3093 / 3227 / 3277 pins still hold under dual-wire.
