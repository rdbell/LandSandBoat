#include "test_universal_clear_slot_3469.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "universal ShouldClearSlot 3469 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline ClearSlot range gate for dual-wire cross-check (dedicated 3469):
//   slotInRange
...
// Compact dual-wire pin matching Go pinShouldClearSlot3469 / C++ capacity:
//   slotInRange
...
// dedicated slice 3469 expand residual 2813 / prior 2980 / prior 3354 / prior 3415).
//
// Coverage:
//   - free == inline == pin == slotInRange
//   - residual poles (2813 / prior 2980 / prior 3354 / prior 3415) still hold
...
auto runUniversalClearSlot3469SelfTests() -> bool
{
    ...
    // Residual 2813 / prior 2980 / prior 3354 / prior 3415 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Classic dual poles / residual 2813+prior 2980+prior 3354+prior 3415 surface.
        { true, true, "in-range accepts" },
        { false, false, "out-of-range rejects" },

        // Residual 2813 / prior 2980 / prior 3354 / prior 3415 pins (full 2^1 surface, labeled).
