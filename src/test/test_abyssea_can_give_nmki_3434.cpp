#include "test_abyssea_can_give_nmki_3434.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "abyssea CanGiveNMKI 3434 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua xi.abyssea.canGiveNMKI formula for dual-wire checks (slice 3434).
...
// Compact dual-wire pin matching Go pinCanGiveNMKI3434 / C++ capacity
...
// dedicated slice 3434 expand residual 2861 / prior 3314 / 3284 / 3238 /
// 3089 — formula unchanged).
//
// Coverage (mirrors 3314 density on CanGiveNMKI primary):
...
//   - residual 1041 / 2861 / prior 3089 / prior 3238 / 3284 / 3314 pins still hold
...
auto runAbysseaCanGiveNMKI3434SelfTests() -> bool
{
    ...
    // Residual constant / 1041 / 2861 / 3089 / 3238 / 3284 / 3314 pins still hold.
