#include "test_avatarpet_can_apply_buff_3425.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "avatarpet CanApplyBuff 3425 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline tryBuffSpell canApplyBuff formula for dual-wire cross-check
// (slice 3425; residual 2968 / prior dedicated 3152 / 3230 / 3370):
...
// Positive if/else pin matching free function / capacity body (slice 3425).
...
// dedicated slice 3425 expand residual 2968).
//
// Coverage:
