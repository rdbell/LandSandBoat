#include "test_darkixion_double_glow_3443.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "darkixion ShouldDoubleGlowSkill 3443 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline DI_GLOW double-up pure gate for dual-wire cross-check
// (dedicated 3443 expand residual 2915; prior dedicated 3389):
//   animSub == GLOWING
...
// Compact dual-wire pin matching Go pinShouldDoubleGlowSkill3443 /
// free function / capacity body (slice 3443). Equality form only — avoid
...
// 3443 expand residual 2915; prior dedicated 3389 / pure 0985 — formula
// unchanged).
//
// Coverage:
...
//   - dense animSub space
//   - residual 0985 / 2915 / 3389 pins still hold
...
auto runDarkixionDoubleGlow3443SelfTests() -> bool
{
    ...
    // Residual 0985 / 2915 / 3389 ShouldDoubleGlowSkill pins still hold under dual-wire.
