#include "test_jobpoints_apply_raise_3475.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "jobpoints ShouldApplyRaiseJobPoint 3475 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline RaiseJobPoint spend-gate formula for dual-wire cross-check
// (dedicated slice 3475):
...
// Compact dual-wire pin matching Go pinShouldApplyRaiseJobPoint3475 / C++ capacity:
//   cost != 0 && currentJp >= cost
...
// dedicated slice 3475 expand residual 3012 / prior dedicated 3219 /
...
//     prior dedicated 3371 / prior dedicated 3421 pins still hold
...
auto runJobpointsApplyRaise3475SelfTests() -> bool
{
    ...
    // Residual 2803 / 3012 / prior dedicated 3219 / prior dedicated 3275 /
    // prior dedicated 3371 / prior dedicated 3421 pins still hold under dual-wire.
    ok = expect(ShouldApplyRaiseJobPoint(1, 1), "residual 2803/3012/3219/3275/3371/3421: cost 1 / jp 1 applies") && ok;
    ok = expect(!ShouldApplyRaiseJobPoint(0, 100), "residual 2803/3012/3219/3275/3371/3421: cost 0 blocks raise") && ok;
    ok = expect(!ShouldApplyRaiseJobPoint(10, 9), "residual 2803/3012/3219/3275/3371/3421: short JP blocks raise") && ok;
    ok = expect(ShouldApplyRaiseJobPoint(10, 10), "residual 2803/3012/3219/3275/3371/3421: exact JP applies") && ok;
    ...
    const struct
    {
        ...
        // Residual 2803 / 3012 / prior dedicated 3219 / prior dedicated 3275 /
        // prior dedicated 3371 / prior dedicated 3421 poles.
    ...
    for (const auto& c : cases)
    {
        ...
        const bool inlineF = inlineShouldApplyRaiseJobPoint3475(c.cost, c.currentJp);
        const bool pin     = pinShouldApplyRaiseJobPoint3475(c.cost, c.currentJp);
    ...
    for (const uint8 cost : poleCosts)
    {
        if (cost == 0)
        {
            ...
            for (const uint16 jp : zeroJPs)
            {
                ...
                const bool inlineF = inlineShouldApplyRaiseJobPoint3475(cost, jp);
                const bool pin     = pinShouldApplyRaiseJobPoint3475(cost, jp);
    ...
    for (const auto& c : hostCases)
    {
        ...
        const bool  inlineF = inlineShouldApplyRaiseJobPoint3475(cost, c.currentJp);
        const bool  pin     = pinShouldApplyRaiseJobPoint3475(cost, c.currentJp);
    ...
    // prior 3421): spend gate is distinct from presence short-circuit and
    // JobPointCost formula that compose PlanRaiseJobPoint.
    {
