...
#include "test_c2s_guild_buylist_runtime.h"
...
{
    using guildbuylisthelpers::BuildResponsePlan;
    using guildbuylisthelpers::SourceEntry;
    ...
    {
        std::cerr << "c2s GUILD_BUYLIST runtime self-test failed: absent NPC must not send a response\n";
        return false;
    }
    ...
    {
        std::cerr << "c2s GUILD_BUYLIST runtime self-test failed: table rows were not converted\n";
        return false;
    }
    ...
    {
        std::cerr << "c2s GUILD_BUYLIST runtime self-test failed: populated row changed during conversion\n";
        return false;
    }
    ...
    {
        std::cerr << "c2s GUILD_BUYLIST runtime self-test failed: missing Lua fields must default to zero\n";
        return false;
    }
