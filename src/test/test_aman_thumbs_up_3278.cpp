#include "test_aman_thumbs_up_3278.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aman CanThumbsUp 3278 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAMANContainer::canThumbsUp pure half for dual-wire cross-check
// (dedicated 3278 expand residual 2967):
//   cooldownExpired
...
// Compact dual-wire pin matching Go pinCanThumbsUp3278 / C++ capacity
// (direct return):
//   cooldownExpired
...
// dedicated slice 3278 expand residual 2967; prior dedicated 3229).
//
// Coverage:
//   - cooldownExpired true → permit / false → reject
//   - free == inline == pin == cooldownExpired (direct return)
//   - residual 0698 / 2967 / prior dedicated 3150 / 3229 pins still hold
...
auto runAmanThumbsUp3278SelfTests() -> bool
{
    ...
    // Residual 0698 / 2967 / 3150 / 3229 pins still hold under dual-wire.
    ...
    // Residual 2967 / 3150 / 3229 / 0698 still hold under dedicated 3278.
    ok = expect(CanThumbsUp(true) && !CanThumbsUp(false), "residual 2967/3150/3229/0698 under 3278") && ok;
