#include "test_apkallu_can_run_away_3245.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "apkallu can run away 3245 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanRunAway3245:
...
// dedicated slice 3245 expand residual 2880 / prior dedicated 3149 —
// formula unchanged).
//
// Coverage:
...
//   - residual 0925 / 2880 / prior 3149 pins still hold
auto runApkalluCanRunAway3245SelfTests() -> bool
{
    ...
    // Residual 0925 / 2880 / prior 3149 CanRunAway pins still hold under
    // dual-wire (positive pin form for eligible poles).
    ...
    // Prior dedicated 3149 independence: free still matches prior pin.
    for (int32 hate = -20; hate <= 120; ++hate)
    {
