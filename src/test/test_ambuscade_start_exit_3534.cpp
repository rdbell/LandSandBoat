#include "test_ambuscade_start_exit_3534.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "ambuscade start-exit 3534 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onInstanceComplete / onInstanceFailure formula for dual-wire
// checks (slice 3534): player:startEvent(10001) is always called for every char.
...
// Compact dual-wire pin matching C++ capacity formula / Go pinShouldStartExitEvent3534:
//   return true
...
// OmegaXI internal/ambuscade; dedicated slice 3534 expand residual 2917; prior
// dedicated 3488/3438/3382/3109). Formula unchanged:
//
//   ShouldStartExitEvent() = true
//
// Coverage:
//   - free == inline == pin == true
//   - residual 2917 / 3109 / 3382 / 3438 / 3488 / 1089 pins still hold
...
auto runAmbuscadeStartExit3534SelfTests() -> bool
{
    ...
    // Residual constant / 1089 / 2917 / prior dedicated 3109 / 3382 / 3438 / 3488 pins still hold.
    ...
    // Unconditional gate always true; free == inline == pin (direct return true).
    {
    ...
    // Repeated calls stay true (no state); free == inline == pin matching C++.
    ...
    // Residual 2917 / prior dedicated 3488/3438/3382/3109 still hold under dedicated 3534.
    ok = expect(ShouldStartExitEvent(), "residual 2917/3488/3438/3382/3109 pins under 3534") && ok;
