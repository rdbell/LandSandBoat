#include "test_ranged_delete_unlimited_shot_3755.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "ranged ShouldDeleteUnlimitedShot 3755 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline OnRangedAttack UnlimitedShot delete gate for dual-wire cross-check
// (slice 3755 dedicated expand residual 3000; prior 3710 retained):
//   if !hasUnlimitedShot → false
//   else → hitOccured || retainUnlimitedShotMod <= 0
auto inlineShouldDeleteUnlimitedShot3755(
...
// (dedicated slice 3755). Early-return form only — same formula.
//   if !hasUnlimitedShot → false
//   else → hitOccured || retainUnlimitedShotMod <= 0
...
// Prior 3710 pin retained for independence cross-check (same formula).
// free == inline == pin == pin3710.
...
// slice 3755 dedicated expand residual 3000; prior dedicated 3710 retained).
// Formula unchanged.
//
// Coverage:
//   - free == inline == pin == pin3710 (early-return formula)
//   - residual poles: no US; hit always delete; miss retain <=0 / >0; residual 1390/3000/3399/3451/3500/3575/3620/3665/3710
//   - dense hasUS × hit × retain compose
//   - prior 3710 independence (suite retained)
...
auto runRangedDeleteUnlimitedShot3755SelfTests() -> bool
{
    ...
    // Residual 1390 / residual dual-wire 3000 / dedicated 3399 / 3451 / 3500 / 3575 / 3620 / 3665 / 3710 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 1390 / 3000 / 3399 / 3451 / 3500 / 3575 / 3620 / 3665 / 3710 re-pins.
    ...
    for (const auto& c : cases)
    {
        ...
        const bool inlineF = inlineShouldDeleteUnlimitedShot3755(c.hasUnlimitedShot, c.hitOccured, c.retainUnlimitedShotMod);
        const bool pinF    = pinShouldDeleteUnlimitedShot3755(c.hasUnlimitedShot, c.hitOccured, c.retainUnlimitedShotMod);
        const bool pin3710 = pinShouldDeleteUnlimitedShot3710(c.hasUnlimitedShot, c.hitOccured, c.retainUnlimitedShotMod);
    ...
    // Prior 3710 independence: free == prior 3710 pin poles (suite retained).
    // free == inline == pin == pin3710.
    ok = expect(ShouldDeleteUnlimitedShot(true, true, 5) == pinShouldDeleteUnlimitedShot3710(true, true, 5),
                "prior 3710 independence: free == 3710 pin del hit") &&
         ok;
    ok = expect(ShouldDeleteUnlimitedShot(false, true, 0) == pinShouldDeleteUnlimitedShot3710(false, true, 0),
                "prior 3710 independence: free == 3710 pin no us") &&
         ok;
    ok = expect(ShouldDeleteUnlimitedShot(true, false, 1) == pinShouldDeleteUnlimitedShot3710(true, false, 1),
                "prior 3710 independence: free == 3710 pin retain keep") &&
         ok;
    ok = expect(pinShouldDeleteUnlimitedShot3755(true, false, 0) == pinShouldDeleteUnlimitedShot3710(true, false, 0),
                "prior 3710 independence: 3755 pin == 3710 pin miss retain 0") &&
         ok;
    ok = expect(inlineShouldDeleteUnlimitedShot3755(true, true, 5) == pinShouldDeleteUnlimitedShot3710(true, true, 5),
                "prior 3710 independence: 3755 inline == 3710 pin del hit") &&
         ok;

    // Dense compose: hasUnlimitedShot × hitOccured × retain poles — free == inline == pin == pin3710.
    for (const bool hasUS : { false, true })
    {
        for (const bool hit : { false, true })
        {
                                        ...
                                        static_cast<int16>(1), static_cast<int16>(5), static_cast<int16>(100) })
            {
                ...
                ok              = expect(got == inlineShouldDeleteUnlimitedShot3755(hasUS, hit, retain),
                            "compose free == inline") &&
                     ok;
                ok = expect(got == pinShouldDeleteUnlimitedShot3755(hasUS, hit, retain), "compose free == pin") && ok;
                ok = expect(got == pinShouldDeleteUnlimitedShot3710(hasUS, hit, retain), "compose free == pin3710") && ok;
            }
        }
    }
    ...
    for (const auto& c : composeCases)
    {
        ...
        ok = expect(got == pin3710, "compose free == pin3710") && ok;
    }
    ...
    // Prior 3710 independence under compose: free == 3710 pin residual poles.
    ok = expect(ShouldDeleteUnlimitedShot(true, true, 5) == pinShouldDeleteUnlimitedShot3710(true, true, 5),
                "prior 3710 independence compose: free == 3710 pin del hit") &&
         ok;
    ok = expect(ShouldDeleteUnlimitedShot(false, true, 0) == pinShouldDeleteUnlimitedShot3710(false, true, 0),
                "prior 3710 independence compose: free == 3710 pin no us") &&
         ok;
    ok = expect(ShouldDeleteUnlimitedShot(true, false, 1) == pinShouldDeleteUnlimitedShot3710(true, false, 1),
                "prior 3710 independence compose: free == 3710 pin retain keep") &&
         ok;
