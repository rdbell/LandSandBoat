#include "test_ambuscade_start_exit_3438.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "ambuscade start-exit 3438 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onInstanceComplete / onInstanceFailure formula for dual-wire
// checks (slice 3438): player:startEvent(10001) is always called for every char.
...
// Compact dual-wire pin matching C++ capacity formula / Go pinShouldStartExitEvent3438:
//   return true
...
// OmegaXI internal/ambuscade; dedicated slice 3438 expand residual 2917; prior
...
//   - residual 2917 / 3109 / 3382 / 1089 pins still hold
...
auto runAmbuscadeStartExit3438SelfTests() -> bool
{
    ...
    // Residual constant / 1089 / 2917 / prior dedicated 3109 / 3382 pins still hold.
    ...
    // Residual 2917 / prior dedicated 3382/3109 still hold under dedicated 3438.
    ok = expect(ShouldStartExitEvent(), "residual 2917/3382/3109 pins under 3438") && ok;
