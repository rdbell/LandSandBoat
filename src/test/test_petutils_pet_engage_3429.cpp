#include "test_petutils_pet_engage_3429.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "petutils ShouldPetEngage 3429 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline AttackTarget engage formula for dual-wire cross-check (dedicated 3429
// expand residual 3051; prior dedicated 3375):
...
// Compact dual-wire pin matching Go pinShouldPetEngage3429 / C++ capacity:
//   !hasPreventActionEffect
...
// dedicated slice 3429 expand residual 3051; prior dedicated 3375; pure 1627).
//
// Coverage:
