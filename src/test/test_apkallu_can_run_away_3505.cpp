#include "test_apkallu_can_run_away_3505.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "apkallu can run away 3505 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanRunAway3505:
...
// dedicated slice 3505 expand residual 2880 / prior dedicated ~3460 —
// formula unchanged).
//
// Coverage:
...
//   - residual 0925 / 2880 / prior 3149 / prior 3245 / prior 3287 / prior 3317 / prior 3407 / prior 3460 pins still hold
auto runApkalluCanRunAway3505SelfTests() -> bool
{
    ...
    // prior 3407 / prior 3460 CanRunAway pins still hold under dual-wire (positive
    // pin form for eligible poles).
    ...
    // Prior dedicated 3149 / 3245 / 3287 / 3317 / 3407 / 3460 independence:
