#include "test_garrison_fail_by_death_3514.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "garrison fail-by-death 3514 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// prior dedicated expand 3461 / dedicated 3514):
...
// Compact dual-wire pin matching Go pinShouldFailByDeath3514:
//   allNPCsDead || allPlayersDead
...
// (Lua xi.garrison BATTLE state fail-by-death gate; dedicated slice 3514;
...
//   - residual 2870 / prior dedicated 3073 / prior dedicated expand 3236 /
//     prior dedicated expand 3330 / prior dedicated expand 3406 /
//     prior dedicated expand 3461 pins still hold
...
auto runGarrisonFailByDeath3514SelfTests() -> bool
{
    ...
    // Residual 2870 / prior dedicated 3073 / prior dedicated expand 3236 /
    // prior dedicated expand 3330 / prior dedicated expand 3406 /
    // prior dedicated expand 3461 pins.
    ...
    // Residual 2870 / prior dedicated 3073 / prior dedicated expand 3236 /
    // prior dedicated expand 3330 / prior dedicated expand 3406 /
    // prior dedicated expand 3461 still hold.
    ok = expect(!ShouldFailByDeath(false, false) && ShouldFailByDeath(true, false) &&
                ...
                "residual 2870/3073/3236/3330/3406/3461 wipe gate pins under 3514") &&
         ok;
    ...
    ok = expect(ShouldFailByDeath(false, false) == pinShouldFailByDeath3461(false, false),
                "prior 3461 pin neither dead still holds under 3514") &&
         ok;
    ok = expect(ShouldFailByDeath(true, false) == pinShouldFailByDeath3461(true, false),
                "prior 3461 pin npcs dead still holds under 3514") &&
         ok;
    ok = expect(ShouldFailByDeath(false, true) == pinShouldFailByDeath3461(false, true),
                "prior 3461 pin players dead still holds under 3514") &&
         ok;
    ok = expect(ShouldFailByDeath(true, true) == pinShouldFailByDeath3461(true, true),
                "prior 3461 pin both dead still holds under 3514") &&
         ok;

    // Residual AllNPCsDead compose (2870 sibling) still holds under 3514.
