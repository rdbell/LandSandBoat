#include "test_recast_update_max_charges_3699.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "recast ShouldUpdateMaxCharges 3699 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Load maxCharges update gate for dual-wire cross-check (slice 3699):
//   maxChargesNonzero
...
// Dedicated 3699 pin (expand residual 3122). Positive: return maxChargesNonzero.
auto pinShouldUpdateMaxCharges3699(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3654 pin (retained under 3699 expand residual 3122).
auto pinShouldUpdateMaxCharges3654(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3609 pin (retained under 3699 expand residual 3122).
auto pinShouldUpdateMaxCharges3609(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3564 pin (retained under 3699 expand residual 3122).
auto pinShouldUpdateMaxCharges3564(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3519 pin (retained under 3699 expand residual 3122).
auto pinShouldUpdateMaxCharges3519(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3448 pin (retained under 3699 expand residual 3122).
auto pinShouldUpdateMaxCharges3448(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3391 pin (retained under 3699 expand residual 3122).
...
// (maxCharges != 0 update on existing Load entry; slice 3699 dedicated expand
// residual 3122 / prior dedicated 3654 / 3609 / 3564 / 3519 / 3448 / 3391 / pure 1370).
...
auto runRecastUpdateMaxCharges3699SelfTests() -> bool
{
    ...
    // Residual 3654 / 3609 / 3564 / 3519 / 3448 / 3391 / 3122 / 1370 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 3654 / 3609 / 3564 / 3519 / 3448 / 3391 / 3122 / 1370 pins restated.
        { true, true, "residual 3654/3609/3564/3519/3448/3391/3122/1370 update max" },
        { false, false, "residual 3654/3609/3564/3519/3448/3391/3122/1370 no update max" },
    ...
    for (const auto& c : cases)
    {
        ...
        ok = expect(got == pin3699, "ShouldUpdateMaxCharges dual-wire == pin3699") && ok;
