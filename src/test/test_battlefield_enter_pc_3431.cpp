#include "test_battlefield_enter_pc_3431.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "battlefield ShouldEnterPC 3431 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline InsertEntity TYPE_PC enter-branch formula for dual-wire cross-check
// (dedicated 3431 expand residual 3024; prior dedicated 3381):
//   enter
...
// Compact dual-wire pin matching Go pinShouldEnterPC3431 /
...
// 3431 expand residual 3024 / prior dedicated 3381 / pure 1361).
//
// Coverage:
//   - free == inline == pin residual pins
//   - poles: enter-true / enter-false
//   - residual 1361 / 3024 pins still hold
//   - prior dedicated 3381 poles still hold
...
auto runBattlefieldEnterPC3431SelfTests() -> bool
{
    ...
    // Residual 1361 / prior dual-wire 3024 / prior dedicated 3381 pins still hold.
    ...
    const struct
    {
        ...
        // Residual 1361 / 3024 / prior dedicated 3381 re-pins.
    ...
    // 3302 / 3014 / 3365 / 3024 / 3381): enter is distinct from null-insert,
