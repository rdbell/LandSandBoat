#include "test_zone_high_targid_3520.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "zone ShouldRejectHighCharTargid 3520 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline IncreaseZoneCounter high-char-targid formula for dual-wire cross-check
// (dedicated slice 3520 expand residual 2949; prior dedicated 3457 / 3384):
...
// Compact dual-wire pin matching Go pinShouldRejectHighCharTargid3520 /
...
//   - residual 1363 / 2949 / prior 3384 / prior 3457 poles still hold
...
auto runZoneHighTargid3520SelfTests() -> bool
{
    ...
    // Residual 1363 / 2949 / prior 3384 / prior 3457 pins still hold under dual-wire.
