#include "test_campaign_debit_selected_3441.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "campaign debit selected 3441 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua sigilOnEventFinish apply delCurrency compose for dual-wire checks
// (dedicated 3441 expand residual 3141; prior dedicated 3397 / 3141 retained):
...
// Compact dual-wire pin matching Go pinShouldDebitSelectedEffects3441:
...
// ShouldDebitBonusCost; OmegaXI internal/campaign; dedicated slice 3441 expand
// residual 3141; prior dedicated 3397 / 3141 retained).
//
// Coverage:
//   - free == inline == pin == ShouldDebitBonusCost(SigilBonusCost(...))
//   - residual 3397 / 3141 / 2858 / 1115 pins still hold
...
auto runCampaignDebitSelected3441SelfTests() -> bool
{
    ...
    // Residual 1115 / 2858 / 3141 / 3397 pins still hold under dual-wire.
