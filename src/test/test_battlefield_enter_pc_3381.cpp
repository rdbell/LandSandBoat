#include "test_battlefield_enter_pc_3381.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "battlefield ShouldEnterPC 3381 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline InsertEntity TYPE_PC enter-branch formula for dual-wire cross-check
// (dedicated 3381 expand residual 3024):
//   enter
...
// Compact dual-wire pin matching Go pinShouldEnterPC3381 /
// C++ capacity enter-identity form (formula unchanged from 1361 / 3024):
//   enter
...
// 3381 expand residual 3024 / pure 1361).
//
// Coverage:
...
auto runBattlefieldEnterPC3381SelfTests() -> bool
{
    ...
    // Residual 1361 / prior dual-wire 3024 pins still hold under dedicated expand.
    ...
    // 3302 / 3014 / 3365 / 3024): enter is distinct from null-insert, already-in,
    // PC under-capacity, and register. Siblings left alone beyond pins —
