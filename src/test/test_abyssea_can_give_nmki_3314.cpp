#include "test_abyssea_can_give_nmki_3314.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "abyssea CanGiveAtmaNMKI 3314 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua giveNMDrops atma-path formula for dual-wire checks (slice 3314):
...
// Compact dual-wire pin matching Go pinCanGiveAtmaNMKI3314 / C++ capacity
...
// internal/abyssea; dedicated slice 3314 expand residual 2861 /
...
//   - residual 1041 / 2861 / prior 3089 / prior 3238 / prior 3284 pins still hold
auto runAbysseaCanGiveNMKI3314SelfTests() -> bool
{
    ...
    // Residual constant / 1041 / 2861 / 3089 / 3238 / 3284 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2861 / 3089 / 3238 / 3284 atma poles.
