#include "test_dynamis_can_unlock_sj_3476.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "dynamis CanUnlockSJ 3476 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua formula for dual-wire cross-check (slice 3476 expand residual 2921):
...
// Compact dual-wire pin matching Go pinCanUnlockSJ3476:
...
// slice 3476 dedicated expand residual 2921; prior dedicated 3422 / 3151 retained).
//
// Coverage:
