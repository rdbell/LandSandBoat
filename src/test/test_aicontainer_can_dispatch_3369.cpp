#include "test_aicontainer_can_dispatch_3369.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aicontainer CanDispatch 3369 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAIContainer public controller-forward presence gate for dual-wire
// cross-check (dedicated 3369 expand residual 2947; prior dedicated 3222):
//   hasController
...
// Compact dual-wire pin matching Go pinCanDispatch3369 / C++ capacity
// identity form (formula unchanged from 1189 / 2947 / 3222). Direct return of
...
// (hasController identity; OmegaXI internal/aicontainer; dedicated slice 3369
// expand residual 2947; prior dedicated 3222; pure 1189).
//
// Coverage:
...
auto runAicontainerCanDispatch3369SelfTests() -> bool
{
    ...
    // Residual independence (1189 / 2947 / 3222 / 2952 / 3272 / 3303 left alone):
