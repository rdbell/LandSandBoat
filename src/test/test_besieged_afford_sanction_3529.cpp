#include "test_besieged_afford_sanction_3529.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "besieged CanAffordSanction 3529 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onEventFinish sanctionCost for dual-wire cross-check (slice 3529):
//   sanctionCost = 100
...
// Compact dual-wire pin matching Go pinCanAffordSanction3529 / C++ capacity
// (direct return form):
//   imperialStanding >= SanctionAffordCost(option)
...
// internal/besieged; dedicated slice 3529 expand residual 2945 —
// formula unchanged; prior dedicated ~3472).
//
// Coverage:
//   - free == inline == pin == (standing >= SanctionAffordCost(option))
//   - residual 1120 / 2945 / 3093 / 3227 / 3277 / 3307 / 3418 / 3472 pins still hold
...
auto runBesiegedAffordSanction3529SelfTests() -> bool
{
    ...
    // Residual constant / 1120 / 2945 / 3093 / 3227 / 3277 / 3307 / 3418 / 3472 pins still hold under dual-wire.
