#include "test_extravaganza_can_afford_cipher_3292.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "extravaganza CanAffordCipher 3292 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua shadowEraFinish notes gate for dual-wire cross-check
// (dedicated 3292 expand residual 2881; prior 3262):
//   notes >= 1000
...
// Compact dual-wire pin matching Go pinCanAffordCipher3292:
...
// internal/extravaganza; dedicated slice 3292 expand residual 2881;
// prior dedicated 3262 / 3153 retained).
//
// Coverage:
//   - free == inline == pin == notes >= CipherPurchaseNotes
//   - CipherPurchaseNotes == 1000 pin
//   - residual 2881 / 3262 / 3153 / 0949 pins still hold
...
auto runExtravaganzaCanAffordCipher3292SelfTests() -> bool
{
    ...
    // Residual 2881 / 3262 / 3153 / 0949 CanAffordCipher pins still hold under dual-wire.
