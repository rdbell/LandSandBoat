#include "test_colonizationreive_spawn_on_enable_3411.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "colonizationreive ShouldSpawnOnEnable 3411 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua enableReive spawn gate for dual-wire cross-check
// (dedicated 3411 expand residual 2882 / prior 3335 / prior 3163):
...
// Compact dual-wire pin matching Go pinShouldSpawnOnEnable3411 / C++ capacity
// (return !isAlive):
//   !isAlive
...
// OmegaXI internal/colonizationreive; dedicated slice 3411 expand residual
// 2882 / prior dedicated 3335 / prior dedicated 3163 — formula unchanged).
//
// Coverage:
//   - free == inline == pin == !isAlive
//   - residual poles: isAlive true / false
//   - dense 2^1 boolean space
//   - residual 1038 / 2882 / prior 3163 / prior 3335 pins still hold
...
auto runColonizationreiveSpawnOnEnable3411SelfTests() -> bool
{
    ...
    // Residual 1038 / 2882 / prior 3163 / prior 3335 pins still hold under dual-wire.
