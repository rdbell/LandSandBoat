#include "test_ambuscade_start_exit_3488.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "ambuscade start-exit 3488 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua onInstanceComplete / onInstanceFailure formula for dual-wire
// checks (slice 3488): player:startEvent(10001) is always called for every char.
...
// Compact dual-wire pin matching C++ capacity formula / Go pinShouldStartExitEvent3488:
//   return true
...
// OmegaXI internal/ambuscade; dedicated slice 3488 expand residual 2917; prior
// dedicated 3438/3382/3109). Formula unchanged:
//
//   ShouldStartExitEvent() = true
//
// Coverage:
//   - free == inline == pin == true
//   - residual 2917 / 3109 / 3382 / 3438 / 1089 pins still hold
...
auto runAmbuscadeStartExit3488SelfTests() -> bool
{
    ...
    // Residual constant / 1089 / 2917 / prior dedicated 3109 / 3382 / 3438 pins still hold.
    ...
    // Residual 2917 / prior dedicated 3438/3382/3109 still hold under dedicated 3488.
    ok = expect(ShouldStartExitEvent(), "residual 2917/3438/3382/3109 pins under 3488") && ok;
