#include "test_command_audit_gm_command_3400.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "command ShouldAuditGMCommand 3400 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CCommandHandler::call audit gate for dual-wire cross-check (dedicated 3400):
...
// Compact dual-wire pin matching Go pinShouldAuditGMCommand3400 / C++ capacity
// positive form (formula unchanged from 2792 / 3011 / 3161):
...
// OmegaXI internal/command; dedicated slice 3400; residual expand 3011 / pure 2792;
// prior dedicated expand 3161).
//
// Coverage:
//   - free == inline == pin positive form
//   - poles: audit 0 always false; level vs permission; signed permission edge
//   - residual 3011 / 2792 / 3161 pins still hold
...
auto runCommandAuditGMCommand3400SelfTests() -> bool
{
    ...
    // Residual 2792 / 3011 / 3161 pins still hold under dedicated dual-wire.
    ...
    const struct
    {
        ...
        // Residual 3011 / 2792 / 3161 re-pins.
