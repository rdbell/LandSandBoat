#include "test_aman_thumbs_up_3308.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aman CanThumbsUp 3308 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAMANContainer::canThumbsUp pure half for dual-wire cross-check
// (dedicated 3308 expand residual 2967):
//   cooldownExpired
...
// Compact dual-wire pin matching Go pinCanThumbsUp3308 / C++ capacity
// (direct return):
//   cooldownExpired
...
// dedicated slice 3308 expand residual 2967; prior dedicated 3278).
//
// Coverage:
//   - cooldownExpired true → permit / false → reject
//   - free == inline == pin == cooldownExpired (direct return)
//   - residual 0698 / 2967 / prior dedicated 3150 / 3229 / 3278 pins still hold
...
auto runAmanThumbsUp3308SelfTests() -> bool
{
    ...
    // Residual 0698 / 2967 / 3150 / 3229 / 3278 pins still hold under dual-wire.
    ...
    // Residual 2967 / 3150 / 3229 / 3278 / 0698 still hold under dedicated 3308.
    ok = expect(CanThumbsUp(true) && !CanThumbsUp(false), "residual 2967/3150/3229/3278/0698 under 3308") && ok;
