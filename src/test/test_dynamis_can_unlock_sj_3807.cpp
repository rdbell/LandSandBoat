#include "test_dynamis_can_unlock_sj_3807.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "dynamis CanUnlockSJ 3807 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua formula for dual-wire cross-check (slice 3807 expand residual 2921):
...
// Compact dual-wire pin matching Go pinCanUnlockSJ3807:
...
//   hasSJRestriction ? 1 : 0
// free==inline==pin==pin3762 required for residual expand 3807.
...
// slice 3807 dedicated expand residual 2921; prior dedicated 3762 / 3717 / 3672 / 3627 / 3582 / 3538 / 3476 / 3422 / 3151 retained).
//
// Coverage:
//   - has SJ_RESTRICTION → 1; no restriction → 0
//   - free == inline == pin == pin3762 == hasSJRestriction ? 1 : 0
...
auto runDynamisCanUnlockSJ3807SelfTests() -> bool
{
    ...
    // --- Core branches: free == inline == pin == pin3762 == formula ---
    ...
    // free == pin3762 (required dual-wire identity for residual expand).
    ok = expect(CanUnlockSJ(true) == pinCanUnlockSJ3762(true), "free==pin3762 hasSJ=true") && ok;
    ok = expect(CanUnlockSJ(false) == pinCanUnlockSJ3762(false), "free==pin3762 hasSJ=false") && ok;
    ...
    // Dense 2^1 compose: free == inline == pin == pin3762 == formula
    // (and prior 3762 / 3717 / 3672 / 3627 / 3582 / 3538 / 3476 / 3422 / 3151 pins).
