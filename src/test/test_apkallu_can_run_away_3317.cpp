#include "test_apkallu_can_run_away_3317.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "apkallu can run away 3317 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanRunAway3317:
...
// dedicated slice 3317 expand residual 2880 / prior dedicated ~3287 —
// formula unchanged).
//
// Coverage:
...
//   - residual 0925 / 2880 / prior 3149 / prior 3245 / prior 3287 pins still hold
auto runApkalluCanRunAway3317SelfTests() -> bool
{
    ...
    // Residual 0925 / 2880 / prior 3149 / prior 3245 / prior 3287 CanRunAway
    // pins still hold under dual-wire (positive pin form for eligible poles).
    ...
    // Prior dedicated 3149 / 3245 / 3287 independence: free still matches prior pins.
    for (int32 hate = -20; hate <= 120; ++hate)
    {
