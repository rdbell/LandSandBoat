#include "test_colonizationreive_spawn_on_enable_3499.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "colonizationreive ShouldSpawnOnEnable 3499 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua enableReive spawn gate for dual-wire cross-check
// (dedicated 3499 expand residual 2882 / prior 3465 / prior 3411 / prior 3335 /
// prior 3163):
...
// Compact dual-wire pin matching Go pinShouldSpawnOnEnable3499 / C++ capacity
// (return !isAlive):
//   !isAlive
...
// OmegaXI internal/colonizationreive; dedicated slice 3499 expand residual
// 2882 / prior dedicated 3465 / prior dedicated 3411 / prior dedicated 3335 /
...
//   - residual 1038 / 2882 / prior 3163 / prior 3335 / prior 3411 / prior 3465 pins still hold
...
auto runColonizationreiveSpawnOnEnable3499SelfTests() -> bool
{
    ...
    // Residual 1038 / 2882 / prior 3163 / prior 3335 / prior 3411 / prior 3465 pins still hold under dual-wire.
