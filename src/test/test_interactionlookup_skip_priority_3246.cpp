#include "test_interactionlookup_skip_priority_3246.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "interactionlookup ShouldSkipPrioritySelection 3246 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline interaction_lookup.lua getHighestPriorityActions early-return gate
// for dual-wire cross-check (dedicated 3246):
//   empty || firstIsNumber
...
// Compact dual-wire pin matching Go pinShouldSkipPrioritySelection3246 /
// C++ capacity (formula unchanged from 1094 / 2953 / 3167):
//   empty || firstIsNumber
...
// OmegaXI internal/interactionlookup; dedicated slice 3246; residual expand
// 2953 / prior 3167 / pure 1094).
//
// Coverage:
//   - free == inline == pin positive form (empty || firstIsNumber)
//   - residual poles + dense 2^2
//   - residual 2953 / 1094 / prior 3167 pins still hold
...
auto runInteractionlookupSkipPriority3246SelfTests() -> bool
{
    ...
    // Residual 1094 / 2953 / prior 3167 pins still hold under dedicated dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2953 / 1094 / prior 3167 re-pins.
    ...
    // Residual 1094 / 2953 / prior 3167 poles still hold under dual-wire.
