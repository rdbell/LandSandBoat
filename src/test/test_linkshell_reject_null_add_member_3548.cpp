#include "test_linkshell_reject_null_add_member_3548.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "linkshell ShouldRejectNullAddMember 3548 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldRejectNullAddMember3548 / C++
...
// (charNull identity; OmegaXI internal/linkshell; dedicated slice 3548;
// residual expand 2929 / pure 1354; prior dedicated expands 3195 / 3489).
//
// Coverage:
//   - free == inline == pin identity form
//   - poles: null rejects; non-null allows
//   - residual 2929 / 1354 / prior dedicated 3195 / 3489 pins still hold
//   - host-style inject + residual independence (2958 / 3079)
//   - prior dedicated 3195 / 3489 independence (RETAINED)
auto runLinkshellRejectNullAddMember3548SelfTests() -> bool
{
    ...
    // Residual 1354 / 2929 / prior dedicated 3195 / 3489 pins still hold under
    // dedicated dual-wire expand.
    ...
    const struct
    {
        ...
        // Residual 2929 / 1354 / prior dedicated 3195 / 3489 re-pins.
    ...
    // Residual independence (1354 / 2929 / 3195 / 3489 / 2958 / 3079):
    // AddMember null reject is distinct from duplicate-add and online-null gates.
    // Prior dedicated 3195 / 3489 independence (RETAINED under this expand).
