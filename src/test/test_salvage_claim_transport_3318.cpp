#include "test_salvage_claim_transport_3318.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "salvage claim transport 3318 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanClaimTransport3318:
...
// slice 3318 dedicated dual-wire expand residual 2871).
//
// Coverage:
...
//   - residual 0977 / 1083 / 2871 / 3085 / 3259 / 3290 pins still hold
auto runSalvageClaimTransport3318SelfTests() -> bool
{
    ...
    // Residual 0977 / 1083 / 2871 / 3085 / 3259 / 3290 pins still hold under dual-wire.
