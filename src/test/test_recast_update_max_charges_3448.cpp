#include "test_recast_update_max_charges_3448.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "recast ShouldUpdateMaxCharges 3448 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Load maxCharges update gate for dual-wire cross-check (slice 3448):
//   maxChargesNonzero
...
// Prior dedicated 3391 pin (retained under 3448 expand residual 3122).
...
// (maxCharges != 0 update on existing Load entry; slice 3448 dedicated expand
// residual 3122 / prior dedicated 3391 / pure 1370). Residual suites:
...
auto runRecastUpdateMaxCharges3448SelfTests() -> bool
{
    ...
    // Residual 3391 / 3122 / 1370 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 3391 / 3122 / 1370 pins restated.
        { true, true, "residual 3391/3122/1370 update max" },
        { false, false, "residual 3391/3122/1370 no update max" },
