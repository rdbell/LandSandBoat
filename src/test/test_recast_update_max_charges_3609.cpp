#include "test_recast_update_max_charges_3609.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "recast ShouldUpdateMaxCharges 3609 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Load maxCharges update gate for dual-wire cross-check (slice 3609):
//   maxChargesNonzero
...
// Dedicated 3609 pin (expand residual 3122). Positive: return maxChargesNonzero.
auto pinShouldUpdateMaxCharges3609(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3564 pin (retained under 3609 expand residual 3122).
auto pinShouldUpdateMaxCharges3564(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3519 pin (retained under 3609 expand residual 3122).
auto pinShouldUpdateMaxCharges3519(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3448 pin (retained under 3609 expand residual 3122).
auto pinShouldUpdateMaxCharges3448(const bool maxChargesNonzero) -> bool
{
    return maxChargesNonzero;
}

// Prior dedicated 3391 pin (retained under 3609 expand residual 3122).
...
// (maxCharges != 0 update on existing Load entry; slice 3609 dedicated expand
// residual 3122 / prior dedicated 3564 / 3519 / 3448 / 3391 / pure 1370).
...
auto runRecastUpdateMaxCharges3609SelfTests() -> bool
{
    ...
    // Residual 3564 / 3519 / 3448 / 3391 / 3122 / 1370 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 3564 / 3519 / 3448 / 3391 / 3122 / 1370 pins restated.
        { true, true, "residual 3564/3519/3448/3391/3122/1370 update max" },
        { false, false, "residual 3564/3519/3448/3391/3122/1370 no update max" },
    ...
    for (const auto& c : cases)
    {
        ...
        ok = expect(got == pin3609, "ShouldUpdateMaxCharges dual-wire == pin3609") && ok;
