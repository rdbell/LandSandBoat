#include "test_salvage_can_open_door_3133.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "salvage can open door 3133 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinCanOpenDoor3133:
...
//   - residual 0977 / 1083 / 2892 pins still hold
auto runSalvageCanOpenDoor3133SelfTests() -> bool
{
    ...
    // Residual 0977 / 1083 / 2892 CanOpenDoor pins still hold under dual-wire.
