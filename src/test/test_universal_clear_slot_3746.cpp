#include "test_universal_clear_slot_3746.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "universal ShouldClearSlot 3746 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline ClearSlot range gate for dual-wire cross-check (dedicated 3746):
//   slotInRange
...
// Compact dual-wire pin matching Go pinShouldClearSlot3746 / C++ capacity:
//   slotInRange
...
// Prior 3701 pin for independence cross-check (formula unchanged):
//   slotInRange
auto pinShouldClearSlot3701(const bool slotInRange) -> bool
{
    return slotInRange;
}
...
// dedicated slice 3746 expand residual 2813 / prior 2980 / prior 3354 /
// prior 3415 / prior 3469 / prior 3532 / prior 3566 / prior 3611 / prior 3656 /
// prior 3701).
//
// Coverage:
//   - free == inline == pin == pin3701 == slotInRange
//   - residual poles (2813 / prior 2980 / prior 3354 / prior 3415 / prior 3469 / prior 3532 / prior 3566 / prior 3611 / prior 3656 / prior 3701) still hold
//   - prior 3701 pin independence
...
auto runUniversalClearSlot3746SelfTests() -> bool
{
    ...
    // Residual 2813 / prior 2980 / prior 3354 / prior 3415 / prior 3469 / prior 3532 / prior 3566 / prior 3611 / prior 3656 / prior 3701 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Classic dual poles / residual 2813+prior 2980+prior 3354+prior 3415+prior 3469+prior 3532+prior 3566+prior 3611+prior 3656+prior 3701 surface.
        { true, true, "in-range accepts" },
        { false, false, "out-of-range rejects" },

        // Residual 2813 / prior 2980 / prior 3354 / prior 3415 / prior 3469 / prior 3532 / prior 3566 / prior 3611 / prior 3656 / prior 3701 pins (full 2^1 surface, labeled).
    ...
    for (const auto& c : cases)
    {
        ...
        // free == pin3701.
        ok = expect(got == pinShouldClearSlot3701(c.slotInRange), "free == pin3701") && ok;
    }
    ...
    // Dense compose: full 2^1 boolean space free == inline == pin == pin3701.
    for (const bool slotInRange : { false, true })
    {
        ...
        const bool pin3701 = pinShouldClearSlot3701(slotInRange);
        const bool want    = slotInRange;
        ok                 = expect(got == want, "compose free == pin formula") && ok;
        ok                 = expect(got == inlineF && got == pin, "compose free == inline == pin") && ok;
        ok                 = expect(got == pin3701, "compose free == pin3701") && ok;
    }
    ...
    // Prior 3701 pin independence: free == prior 3701 pin.
    for (const bool slotInRange : { false, true })
    {
        const bool got      = ShouldClearSlot(slotInRange);
        const bool priorPin = pinShouldClearSlot3701(slotInRange);
        ok                  = expect(got == priorPin, "prior 3701 pin independence") && ok;
    }
