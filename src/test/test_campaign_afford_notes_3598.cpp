#include "test_campaign_afford_notes_3598.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "campaign afford notes 3598 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline Lua sigilOnEventFinish shop afford gate for dual-wire checks
// (dedicated 3598 expand residual 2946; prior dedicated 3553 retained):
...
// Compact dual-wire pin matching Go pinCanAffordAlliedNotes3598 / C++ capacity:
//   notes >= price
...
// OmegaXI internal/campaign; dedicated slice 3598 expand residual 2946;
// prior dedicated 3553 independence retained).
//
// Coverage:
//   - free == inline == pin == (notes >= price)
//   - residual 2946 / 3072 / 3226 / 3273 / 3304 / 3496 / 3553 / 1115 pins still hold
//   - prior 3553 independence: free == pin3553 (same notes >= price formula)
...
auto runCampaignAffordNotes3598SelfTests() -> bool
{
    ...
    // Residual 1115 / 2946 / 3072 / 3226 / 3273 / 3304 / 3496 / 3553 pins still hold under dual-wire.
    ...
    const struct
    {
        ...
        // Residual 2946 / 3072 / 3226 / 3273 / 3304 / 3496 / 3553 poles.
    ...
    for (const auto& c : cases)
    {
        ...
        // Positive form: free == inline == pin (prior 3553 independence same formula).
    ...
    // Production path semantics still hold (incl. prior 3553 independence).
    ...
    ok = expect(CanAffordAlliedNotes(1000, 1000) == pinCanAffordAlliedNotes(1000, 1000),
                "formula exact free == pin (prior 3553 independence)") &&
         ok;
    ok = expect(CanAffordAlliedNotes(999, 1000) == pinCanAffordAlliedNotes(999, 1000),
                "formula short free == pin (prior 3553 independence)") &&
         ok;
