#include "test_attack_run_enspell_3456.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "attack ShouldRunEnspell 3456 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline OnAttack live-target enspell gate for dual-wire cross-check
// (dedicated slice 3456; prior 3390 retained):
//   targetHPP > 0
...
// Compact dual-wire pin matching Go pinShouldRunEnspell3456 / C++ capacity:
//   targetHPP > 0
...
// (targetHPP > 0; suppresses enspell after target dies; dedicated slice 3456;
// prior dedicated 3390 retained; residual expand 3046 / pure 1399).
//
// Coverage:
//   - free == inline == pin == (targetHPP > 0)
//   - residual 1399 / 3046 and prior dedicated 3390 pins still hold
...
auto runAttackRunEnspell3456SelfTests() -> bool
{
    ...
    // Residual 1399 / 3046 and prior dedicated 3390 pins still hold under dual-wire.
    ...
    // Sibling residual 1399 still hold (not re-expanded under 3456).
