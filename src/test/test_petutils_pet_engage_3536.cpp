#include "test_petutils_pet_engage_3536.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "petutils ShouldPetEngage 3536 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline AttackTarget engage formula for dual-wire cross-check (dedicated 3536
// expand residual 3051; prior dedicated 3484 / 3429 / 3375):
...
// Compact dual-wire pin matching Go pinShouldPetEngage3536 / C++ capacity:
//   !hasPreventActionEffect
...
// dedicated slice 3536 expand residual 3051; prior dedicated 3484 / 3429 / 3375; pure 1627).
//
// Coverage:
