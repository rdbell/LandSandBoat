#include "test_aman_thumbs_up_3229.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "aman CanThumbsUp 3229 self-test failed: " << label << '\n';
    }
    return condition;
}

// Inline CAMANContainer::canThumbsUp pure half for dual-wire cross-check
// (dedicated 3229 expand residual 2967):
//   cooldownExpired
...
// Compact dual-wire pin matching Go pinCanThumbsUp3229 / C++ capacity
// (direct return):
//   cooldownExpired
...
// dedicated slice 3229 expand residual 2967).
//
// Coverage:
//   - cooldownExpired true → permit / false → reject
//   - free == inline == pin == cooldownExpired (direct return)
//   - residual 0698 / 2967 / prior dedicated 3150 pins still hold
...
auto runAmanThumbsUp3229SelfTests() -> bool
{
    ...
    // Residual 0698 / 2967 / 3150 pins still hold under dual-wire.
    ...
    // Residual 2967 / 3150 / 0698 still hold under dedicated 3229.
    ok = expect(CanThumbsUp(true) && !CanThumbsUp(false), "residual 2967/3150/0698 under 3229") && ok;
