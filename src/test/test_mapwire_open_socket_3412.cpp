#include "test_mapwire_open_socket_3412.h"
...
auto expect(const bool condition, const char* const label) -> bool
{
    if (!condition)
    {
        std::cerr << "mapwire ShouldOpenSocket 3412 self-test failed: " << label << '\n';
    }
    return condition;
}
...
// Compact dual-wire pin matching Go pinShouldOpenSocket3412:
//   !isTestServer
...
// (!isTestServer; OmegaXI internal/mapwire; dedicated slice 3412;
// expand residual 2948 / pure 2660; prior dedicated 3169 / 3232).
//
// Coverage:
//   - free == inline == pin == !isTestServer (identity-not)
//   - residual poles true/false
//   - residual 2660 / 2948 / prior 3169 / prior 3232 pins still hold
...
auto runMapwireOpenSocket3412SelfTests() -> bool
{
    ...
    // Residual 2948 / 2660 / 3169 / 3232 still hold under dedicated suite.
    ok = expect(ShouldOpenSocket(false), "residual production open under 3412") && ok;
    ok = expect(!ShouldOpenSocket(true), "residual test skip under 3412") && ok;
