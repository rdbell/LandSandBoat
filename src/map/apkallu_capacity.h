...
//   - 3287: CanRunAway dedicated dual-wire expand residual 2880 (prior ~3245)
//
// Dual-wire index:
...
//   - 3287: CanRunAway (GetHateTier(hate) >= 3 ≡ hate >= 45)
//
...
// Dedicated dual-wire suite: slice 3287 / test_apkallu_can_run_away_3287.
...
// ---------------------------------------------------------------------------
// Slice 2880 / 3149 / 3245 / 3287 — CanRunAway pure dual-wire
//
// Formula (slice 3287 dedicated dual-wire expand residual 2880; prior
// dedicated ~3245 / 3149; pure inject 0925 — formula unchanged):
...
// 3149 / test_apkallu_can_run_away_3149 and 3245 /
// test_apkallu_can_run_away_3245. Dedicated dual-wire suite is
// test_apkallu_can_run_away_3287. Host still owns getZoneID, server-variable
