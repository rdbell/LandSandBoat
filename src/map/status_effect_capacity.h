...
// --- Slice 3080 / 3348 / 3428 / 3481: ShouldRejectNullStatusEffect pure dual-wire ---
...
// Dedicated dual-wire expand residual: slice 3481 (test_status_reject_null_3481).
...
// expand residual 3080 (formula unchanged; retained).
// Index 3481: statuseffect.ShouldRejectNullStatusEffect dedicated dual-wire
// expand residual 3080 (formula unchanged; prior dedicated 3428 / 3348 retained).

// ShouldRejectNullStatusEffect mirrors PStatusEffectPtr == nullptr.
//
// Formula (slice 3481 dedicated dual-wire expand residual 3080; prior dedicated
// 3428 / 3348 / pure 1371 — formula unchanged):
//   isNull
//
...
// are test_status_reject_null_3348 / test_status_reject_null_3428. Dedicated
// expand residual suite is test_status_reject_null_3481. Formula is unchanged;
