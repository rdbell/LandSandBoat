...
// --- Slice 3080 / 3348 / 3428 / 3481 / 3526: ShouldRejectNullStatusEffect pure dual-wire ---
...
// Dedicated dual-wire expand residual: slice 3526 (test_status_reject_null_3526).
...
// expand residual 3080 (formula unchanged; retained).
// Index 3526: statuseffect.ShouldRejectNullStatusEffect dedicated dual-wire
// expand residual 3080 (formula unchanged; prior dedicated 3481 / 3428 / 3348 retained).

// ShouldRejectNullStatusEffect mirrors PStatusEffectPtr == nullptr.
//
// Formula (slice 3526 dedicated dual-wire expand residual 3080; prior dedicated
// 3481 / 3428 / 3348 / pure 1371 — formula unchanged):
//   isNull
//
...
// test_status_reject_null_3481. Dedicated expand residual suite is
// test_status_reject_null_3526. Formula is unchanged; this slice only expands
