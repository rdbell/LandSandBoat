...
//   - 3645: ShouldRejectPCAddFull dedicated dual-wire
//           (TYPE_PC + PARTY_PCS + partyFull; residual expand 2928 /
...
// 3600 / test_party_reject_pc_add_full_3600 (retained);
// dedicated dual-wire suite: 3645 / test_party_reject_pc_add_full_3645),
...
//
// Formula (slice 3645 dedicated dual-wire; residual expand 2928 /
// prior dedicated 3600 / 3555 / 3498 / 3200 / pure 1327 / 1350 — formula unchanged):
...
// 3555 / test_party_reject_pc_add_full_3555,
// 3600 / test_party_reject_pc_add_full_3600 (retained).
// Dedicated dual-wire suite is test_party_reject_pc_add_full_3645. Formula is
// unchanged; dedicated suite expands free==inline==pin==pin3600 poles + dense 2^3.
