...
//   - 3599: ShouldEnterPC dedicated dual-wire
//           (enter identity; residual expand 3024 /
...
//
// Formula (slice 3599 dedicated dual-wire; residual expand 3024 /
// prior dedicated 3554 / 3497 / 3431 / 3381 / pure 1361 — formula unchanged):
//   enter
//
// enter — host InsertEntity enter flag
...
// Dedicated dual-wire suite is test_battlefield_enter_pc_3599. Formula is
// unchanged; this slice only expands dual-wire docs + index + dedicated suite
// (free == inline == pin residual pins / free == pin3554).
// Sibling dual-wires left alone: 3198 null-insert, 3216 already-in,
