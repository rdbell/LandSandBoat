...
//           (afford_sanction.go)
//   - 3227: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3277: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3307: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3418: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3472: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3529: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3572: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3617: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3662: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3707: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3752: CanAffordSanction / SanctionAffordCost prior dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//   - 3797: CanAffordSanction / SanctionAffordCost dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//
// Dual-wire index:
...
//   - 3227: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3277: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3307: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3418: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3472: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3529: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3572: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3617: CanAffordSanction prior dedicated dual-wire expand residual 2945
//   - 3662: CanAffordSanction prior dedicated dual-wire expand residual 2945
...
//   - 3797: CanAffordSanction (imperialStanding >= SanctionAffordCost(option))
//
...
// Sibling CanAffordSanction (3797 / 3752 / 3707 / 3662 / 3617 / 3572 / 3529 / 3472 / 3418 / 3307 / 3277 / 3227 / 3093 / 2945) is independent (left alone).
...
// ---------------------------------------------------------------------------
// Slice 2945 / 3093 / 3227 / 3277 / 3307 / 3418 / 3472 / 3529 / 3572 / 3617 / 3662 / 3707 / 3752 / 3797 — onEventFinish sanction afford
// ---------------------------------------------------------------------------
...
// Dual-wires Go besieged.SanctionAffordCost (afford_sanction.go / 3797
// dedicated expand residual 2945; prior dedicated 3752 / 3707 / 3662 / 3617 / 3572 / 3529 / 3472 / 3418 / 3307 / 3277 / 3227 / 3093).
...
//
// Formula (slice 3797 dedicated dual-wire; residual expand 2945 / prior
// dedicated 3752 / 3707 / 3662 / 3617 / 3572 / 3529 / 3472 / 3418 / 3307 / 3277 / 3227 / 3093 — formula unchanged):
...
// Dual-wires Go besieged.CanAffordSanction (afford_sanction.go / 3797).
...
// test_besieged_afford_sanction_3093, 3227 / test_besieged_afford_sanction_3227,
// 3277 / test_besieged_afford_sanction_3277, 3307 / test_besieged_afford_sanction_3307,
// 3418 / test_besieged_afford_sanction_3418, 3472 / test_besieged_afford_sanction_3472,
...
// Dedicated dual-wire suite is test_besieged_afford_sanction_3797. Host still
