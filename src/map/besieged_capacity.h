...
//   - 3277: CanAffordSanction / SanctionAffordCost dedicated dual-wire
//           expand residual 2945 (afford_sanction.go; formula unchanged)
//
// Dual-wire index:
...
//   - 3277: CanAffordSanction (imperialStanding >= SanctionAffordCost(option))
//
...
// Sibling CanAffordSanction (3277 / 3227 / 3093 / 2945) is independent (left alone).
...
// ---------------------------------------------------------------------------
// Slice 2945 / 3093 / 3227 / 3277 — onEventFinish sanction afford
// ---------------------------------------------------------------------------
...
// Dual-wires Go besieged.SanctionAffordCost (afford_sanction.go / 3277
// dedicated expand residual 2945; prior dedicated 3227 / 3093).
...
//
// Formula (slice 3277 dedicated dual-wire; residual expand 2945 / prior
// dedicated 3227 / 3093 — formula unchanged):
...
// Dual-wires Go besieged.CanAffordSanction (afford_sanction.go / 3277).
...
// Dedicated dual-wire suite is test_besieged_afford_sanction_3277. Host still
