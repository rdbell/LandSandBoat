...
//   - 3624: ShouldIncrementCountOnInsertAt prior dedicated dual-wire (increment_count_insert.go; expand residual 3021)
//   - 3669: ShouldIncrementCountOnInsertAt dedicated dual-wire (increment_count_insert.go; expand residual 3021)
//
// Dual-wire index:
...
//   - 3624: ShouldIncrementCountOnInsertAt = slotEmpty && slotID != 0 (prior dedicated)
//   - 3669: ShouldIncrementCountOnInsertAt = slotEmpty && slotID != 0
//
...
// Prior dedicated dual-wire suites: 3374 / 3432 / 3486 / 3535 / 3579 / 3624
// (test_item_increment_count_insert_3374 / _3432 / _3486 / _3535 / _3579 / _3624).
// Dedicated dual-wire suite: 3669 (test_item_increment_count_insert_3669).
...
// ---------------------------------------------------------------------------
// Slice 3669 — InsertItem count bump (dedicated expand residual 3021;
// prior dedicated 3624 / 3579 / 3535 / 3486 / 3432 / 3374)
// ---------------------------------------------------------------------------

// ShouldIncrementCountOnInsertAt mirrors InsertItem(PItem, SlotID) count bump:
// only empty nonzero slots contribute to m_count.
//
// Formula (slice 3669 dedicated dual-wire expand residual 3021; prior dedicated
// 3624 / 3579 / 3535 / 3486 / 3432 / 3374 / pure 2802 — formula unchanged):
//   slotEmpty && slotID != 0
//
...
// test_item_increment_count_insert_3579, and 3624 /
// test_item_increment_count_insert_3624. Dedicated dual-wire suite is
// test_item_increment_count_insert_3669. Sibling dual-wire range gate:
