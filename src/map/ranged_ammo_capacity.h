...
// --- Slice 3710: ShouldDeleteUnlimitedShot pure dual-wire (dedicated expand residual 3000) ---
...
//
// Dual-wire notes (slice 3710 dedicated expand residual 3000; prior 3665 retained):
//   Formula unchanged from residual 1390 / residual dual-wire 3000 /
//   dedicated 3399 / dedicated 3451 / dedicated 3500 / dedicated 3575 /
//   dedicated 3620 / dedicated 3665:
//     if !hasUnlimitedShot → false
//     else → hitOccured || retainUnlimitedShotMod <= 0
//   Early-return form (production free function + 3710 / 3665 / 3620 / 3575 / 3500 / 3451 / 3399 / 3000 inline/pin):
//     if (!hasUnlimitedShot) return false; return hitOccured || retainUnlimitedShotMod <= 0;
//   Index 3710: attackutils.ShouldDeleteUnlimitedShot pure dual-wire
...
//   Dedicated dual-wire suite: test_ranged_delete_unlimited_shot_3710.
//
...
//
// Formula (slice 3710 dedicated dual-wire expand residual 3000; prior
// dedicated 3665 / 3620 / 3575 / 3500 / 3451 / 3399 / residual 3000 / pure 1390 — formula unchanged):
//   if !hasUnlimitedShot → false
//   else → hitOccured || retainUnlimitedShotMod <= 0
//
...
// (delete_unlimited_shot.go / slice 3710; prior 3665 retained).
