...
//           (retained)
//   - 3445: ShouldStripPartialStealthOnRetain dedicated dual-wire
//           (!stripAllDetectable partial gate; expand residual 3082; prior 3394 retained)
...
// --- Slice 3082 residual / 3394 prior dedicated / 3445 dedicated —
// ShouldStripPartialStealthOnRetain pure dual-wire ---
// Residual dual-wire expand: slice 3082.
// Prior dedicated dual-wire expand residual 3082: slice 3394 (retained).
// Residual pure port: slice 1391 (OnRangedAttack RETAIN_CAMOUFLAGE policy suite).
...
// Prior dedicated dual-wire suite: 3394 / test_ranger_strip_partial_retain_3394
// (retained).
// Dedicated dual-wire suite: 3445 / test_ranger_strip_partial_retain_3445.
// Formula is unchanged; this slice only expands dual-wire docs + index +
// dedicated suite. Sibling residual gates remain on this header
// (facing / chance / strip). Siblings left alone: evaluate_camouflage_retain /
...
//
// Formula (slice 3445 dedicated dual-wire expand residual 3082; prior dedicated
// 3394 / pure 1391 — formula unchanged):
...
// Residual dual-wire suite: 3082 / test_ranger_strip_partial_retain_3082.
// Prior dedicated dual-wire suite: 3394 / test_ranger_strip_partial_retain_3394
// (retained). Dedicated dual-wire suite is test_ranger_strip_partial_retain_3445.
// Formula is unchanged; this slice only expands dual-wire docs + index +
// dedicated suite.
