...
//   - 3284: CanGiveAtmaNMKI dedicated dual-wire expand residual 2861
...
//   - 3284: CanGiveAtmaNMKI (CanGiveNMKI(roll, AtmaNMKIDropChance/*10*/, redProc))
//
// Lua production host (2861 / 3089 / 3238 / 3284): scripts/globals/abyssea.lua
...
// ---------------------------------------------------------------------------
// Slice 2861 / 3089 / 3238 / 3284 — canGiveNMKI roll / red-proc gate
// ---------------------------------------------------------------------------
...
//
// Formula (prior dedicated 3089; residual expand 2861; pure inject 1041;
// CanGiveAtmaNMKI dedicated expand residual 3284 / prior 3238 leaves this
// free function body unchanged):
...
// test_abyssea_can_give_nmki_3089. Prior CanGiveAtmaNMKI expand suite:
// test_abyssea_can_give_nmki_3238. CanGiveAtmaNMKI dedicated dual-wire suite
// is test_abyssea_can_give_nmki_3284. Host still owns math.random,
...
// CanGiveNMKI (production compose for deferred giveNMDrops host).
//
// Formula (slice 3284 dedicated dual-wire expand residual 2861; prior
...
// Dedicated dual-wire suite is test_abyssea_can_give_nmki_3284.
