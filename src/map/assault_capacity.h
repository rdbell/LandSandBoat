...
//   - 3524: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3388 stock / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3571: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3524 stock / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3616: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3571 stock / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3661: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3616 stock / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3706: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3661 stock / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3751: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3706 stock / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3796: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3751 stock / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3841: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3796 stock / 3751 / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//   - 3886: CanIssueTagFromStock dedicated dual-wire expand residual 2867
//           / prior 3841 stock / 3796 / 3751 / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling
//           (npc_handler.go stock gate after ShouldIssueNewTag)
//
// Dual-wire index:
...
//   - 3524: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3388 stock / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3571: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3524 stock / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3616: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3571 stock / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3661: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3616 stock / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3706: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3661 stock / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3751: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3706 stock / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3796: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3751 stock / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3841: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3796 stock / 3751 / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//   - 3886: CanIssueTagFromStock (tagStock > 0; dedicated expand residual 2867
//           / prior 3841 stock / 3796 / 3751 / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / 3440 ShouldIssueNewTag sibling;
//           stock gate after ShouldIssueNewTag)
//
...
// Slice 3388 / 3524 / 3571 — tagStock gate after ShouldIssueNewTag
// ---------------------------------------------------------------------------
...
// Stock gate dual-wires as CanIssueTagFromStock (slice 3388 / 3524 / 3571 / 3616 / 3661 / 3706 / 3751 / 3796 / 3841 / 3886).
...
// currency writeback.
//
// Formula (slice 3886 dedicated dual-wire expand residual 2867 / prior 3841 /
// 3796 / 3751 / 3706 / 3661 / 3616 / 3571 / 3524 / 3388 / pure 1100 — formula unchanged):
...
// ShouldIssueNewTag suites): 2867 / 3145 / 3258. Prior dedicated dual-wire
...
// suite: 3571 / test_assault_issue_tag_3571. Prior dedicated dual-wire expand
// residual suite: 3616 / test_assault_issue_tag_3616. Prior dedicated dual-wire
// expand residual suite: 3661 / test_assault_issue_tag_3661. Prior dedicated dual-wire
// expand residual suite: 3706 / test_assault_issue_tag_3706. Prior dedicated dual-wire
// expand residual suite: 3751 / test_assault_issue_tag_3751. Prior dedicated dual-wire
// expand residual suite: 3796 / test_assault_issue_tag_3796. Prior dedicated dual-wire
// expand residual suite: 3841 / test_assault_issue_tag_3841. Dedicated dual-wire
// expand residual suite is test_assault_issue_tag_3886. Host still owns
// currentAssault / giveKeyItem / currency writeback after this gate.
