...
// internal/petutils/pet_engage.go (slice 3580 dedicated dual-wire
// ShouldPetEngage; residual expand 3051 / prior dedicated 3536 / 3484 / 3429 / 3375 / pure 1627);
...
//   - 3580: ShouldPetEngage dedicated dual-wire
//           (pet_engage.go; expand residual 3051; prior dedicated 3536 / 3484 / 3429 / 3375; pure 1627)
//
...
// Dedicated dual-wire suite (ShouldPetEngage): 3580 (test_petutils_pet_engage_3580).
...
// ShouldPetEngage (slice 3580 dedicated dual-wire; prior 3536 / 3484 / 3429 / 3375 / residual 3051).
...
// ShouldPetEngage (3580 / prior 3536 / 3484 / 3429 / 3375 / residual 3051), ShouldPetDisengage (3081),
...
// ---------------------------------------------------------------------------
// Slice 3580 — AttackTarget prevent-action engage gate (dedicated expand
// residual 3051; prior dedicated 3536 / 3484 / 3429 / 3375 retained; pure 1627 retained)
// ---------------------------------------------------------------------------

// ShouldPetEngage mirrors !HasPreventActionEffect before pet PAI Engage.
//
// Formula (slice 3580 dedicated dual-wire expand residual 3051; prior dedicated
// 3536 / 3484 / 3429 / 3375 / pure 1627 — formula unchanged):
...
// 3536 / test_petutils_pet_engage_3536 (retained).
// Dedicated dual-wire suite is test_petutils_pet_engage_3580.
// Residual pins remain in test_pet_engage_1627. Sibling dual-wire:
...
// test_pet_can_retreat_master_3097. Sibling dual-wire: ShouldPetEngage (3580 /
// prior 3536 / 3484 / 3429 / 3375 / residual 3051), CanAttackTarget (3328 / prior 3298 / 3269 /
...
// Prior pure port: slice 1627 (AttackTarget / RetreatToMaster pure gates).
// Residual pins remain in test_pet_engage_1627; dedicated dual-wire suite is
// test_pet_should_disengage_3081. Sibling dual-wire: ShouldPetEngage (3580 /
// prior 3536 / 3484 / 3429 / 3375 / residual 3051), CanAttackTarget (3328 / prior 3298 / 3269 /
