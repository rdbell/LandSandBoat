...
// internal/petutils/pet_engage.go (slice 3375 dedicated dual-wire
// ShouldPetEngage; residual expand 3051 / pure 1627);
...
//   - 3375: ShouldPetEngage dedicated dual-wire
//           (pet_engage.go; expand residual 3051; pure 1627)
//
...
// Dedicated dual-wire suite (ShouldPetEngage): 3375 (test_petutils_pet_engage_3375).
...
// ShouldPetEngage (slice 3375 dedicated dual-wire; residual 3051).
...
// ShouldPetEngage (3375 / residual 3051), ShouldPetDisengage (3081),
...
// ---------------------------------------------------------------------------
// Slice 3375 — AttackTarget prevent-action engage gate (dedicated expand
// residual 3051; pure 1627 retained)
// ---------------------------------------------------------------------------

// ShouldPetEngage mirrors !HasPreventActionEffect before pet PAI Engage.
//
// Formula (slice 3375 dedicated dual-wire expand residual 3051; pure 1627 —
// formula unchanged):
...
// Dedicated dual-wire suite is test_petutils_pet_engage_3375.
// Residual pins remain in test_pet_engage_1627. Sibling dual-wire:
...
// test_pet_can_retreat_master_3097. Sibling dual-wire: ShouldPetEngage (3375 /
// residual 3051), CanAttackTarget (3328 / prior 3298 / 3269 / residual 3071),
// ShouldPetDisengage (3081).
...
// Prior pure port: slice 1627 (AttackTarget / RetreatToMaster pure gates).
// Residual pins remain in test_pet_engage_1627; dedicated dual-wire suite is
// test_pet_should_disengage_3081. Sibling dual-wire: ShouldPetEngage (3375 /
// residual 3051), CanAttackTarget (3328 / prior 3298 / 3269 / residual 3071),
// CanRetreatToMaster (3097).
