...
//   - 3436: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3386 retained; free==inline==pin; dense 2¹)
//   - 3487: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3436/3386 retained; free==inline==pin; dense 2¹)
//   - 3544: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3487/3436/3386 retained; free==inline==pin; dense 2¹)
//   - 3588: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3544/3487/3436/3386 retained;
//            free==inline==pin==pin3544; dense 2¹)
//   - 3633: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3588/3544/3487/3436/3386 retained;
//            free==inline==pin==pin3588; dense 2¹)
//   - 3678: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3633/3588/3544/3487/3436/3386 retained;
//            free==inline==pin==pin3633; dense 2¹)
//   - 3723: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3678/3633/3588/3544/3487/3436/3386 retained;
//            free==inline==pin==pin3678; dense 2¹)
...
//   - 3858: ShouldRejectNullOnlineMember prior dedicated expand residual 3075
//           (same formula; prior 3813/3768/3723/3678/3633/3588/3544/3487/3436/3386 retained;
//            free==inline==pin==pin3813; dense 2¹)
//   - 3903: ShouldRejectNullOnlineMember dedicated expand residual 3075
//           (same formula; prior 3858/3813/3768/3723/3678/3633/3588/3544/3487/3436/3386 retained;
//            free==inline==pin==pin3858; dense 2¹)
...
// dedicated 3678 + prior dedicated 3723 + prior dedicated 3768 + prior dedicated 3813 + prior dedicated 3858 + dedicated 3903).
...
// 3588 / 3633 / 3678 / 3723 / 3768 / 3813 / 3858 prior dedicated expand; slice 3903 dedicated expand residual 3075):
//   charNull
//
...
// suites remain in test_unity_reject_null_online_3386,
...
// dedicated dual-wire suite is test_unity_reject_null_online_3903
// (free == inline == pin == pin3858 residual pins; dense 2¹). Formula
// unchanged from 1356 / 3075 / 3386 / 3436 / 3487 / 3544 / 3588 / 3633 / 3678 / 3723 / 3768 / 3813 / 3858.
...
// (3075 residual / 3386 / 3436 / 3487 / 3544 / 3588 / 3633 / 3678 / 3723 / 3768 / 3813 / 3858 prior dedicated /
// 3903 dedicated expand), ShouldAddMemberAfterOnlineLookup (3096/3254),
// ShouldReceiveUnityPacket (2933/3190), ShouldEraseUnityChatAfterDelOnline (3116),
// ShouldReturnCachedUnityChat (3130). Residual siblings: always-false return,
// null warning string, exception format (still 1356 residual).
