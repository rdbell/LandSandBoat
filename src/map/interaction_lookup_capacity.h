...
//   - 3410: ShouldSkipPrioritySelection prior dedicated dual-wire
//           (empty || firstIsNumber; residual expand 2953 / prior 3332 / 3246 / 3167)
//   - 3464: ShouldSkipPrioritySelection prior dedicated dual-wire
//           (empty || firstIsNumber; residual expand 2953 / prior 3410 / 3332 / 3246 / 3167)
//   - 3509: ShouldSkipPrioritySelection dedicated dual-wire
//           (empty || firstIsNumber; residual expand 2953 / prior 3464 / 3410 / 3332 / 3246 / 3167)
//
// Dual-wire index:
...
//   - 3410: ShouldSkipPrioritySelection prior dedicated dual-wire suite
//   - 3464: ShouldSkipPrioritySelection prior dedicated dual-wire suite
//   - 3509: ShouldSkipPrioritySelection = empty || firstIsNumber
//
...
// Prior dedicated dual-wire suites: slices 3167 / 3246 / 3332 / 3410 / 3464
...
// test_interactionlookup_skip_priority_3464).
// Dedicated dual-wire suite: slice 3509
// (test_interactionlookup_skip_priority_3509).
...
// ---------------------------------------------------------------------------
// Slice 3509 — getHighestPriorityActions early-return gate
//              (dedicated expand residual 2953; prior 3464 / 3410 / 3332 / 3246 / 3167)
// ---------------------------------------------------------------------------
...
// Residual pin under 2953 / 1094; prior dedicated dual-wire suites: slices 3167 / 3246 / 3332 / 3410 / 3464;
// dedicated dual-wire suite: slice 3509.
...
//   empty || firstIsNumber
//
// Formula (slice 3509 dedicated dual-wire; residual expand 2953 / prior 3464 /
// 3410 / 3332 / 3246 / 3167 / pure 1094 — formula unchanged):
...
// test_interactionlookup_skip_priority_3332 /
// test_interactionlookup_skip_priority_3410 /
// test_interactionlookup_skip_priority_3464. Dedicated dual-wire suite is
// test_interactionlookup_skip_priority_3509. Formula is unchanged; this slice
