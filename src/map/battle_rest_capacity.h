...
// --- Slice 3326: CanRest dedicated dual-wire expand residual 3006 ---
// Index:
...
//   - 3296: CanRest prior dedicated dual-wire expand residual 3006
//   - 3326: CanRest dedicated dual-wire expand residual 3006 (prior ~3296)
//
// Formula index:
//   - 1635 / 3006: CanRest residual pure dual-wire
//   - 3253 / 3296: CanRest prior dedicated dual-wire expand residual 3006
//   - 3326: CanRest = !hasRegenDown && !hasNoRestFlag
...
// Prior dedicated dual-wire: slices 3253 / 3296 (suites retained).
...
// Go dual-wire: aistate.CanRest (internal/aistate/can_rest.go; slice 3326).
...
// test_aistate_can_rest_3296 (prior dedicated expand residual 3006),
// test_aistate_can_rest_3326 (dedicated expand residual 3006; not in
// CMake/main).
//
// Dual-wire notes (slice 3326):
//   Formula unchanged from pure 1635 / residual dual-wire 3006 / prior
//   3253 / 3296:
...
//   poles + dense 2² bool space. Residual 3006 / prior 3253 / 3296 suites
//   retained.

// CanRest mirrors !REGEN_DOWN && !NoRest status flag.
//
// Formula (slice 3326 dedicated dual-wire expand residual 3006; prior 3296 /
// 3253; pure 1635 — formula unchanged):
//   !hasRegenDown && !hasNoRestFlag
//
...
//
// Dual-wire of Go aistate.CanRest (can_rest.go / slice 3326).
// Call site: CBattleEntity::CanRest (~404).
// Coverage: test_aistate_can_rest_3326 (dedicated expand residual 3006;
// not in CMake/main); residual 3006 / prior 3253 / 3296 suites retained.
