...
//   - 3056: ShouldDestroyPendingByPointer (found && pointerMatches; residual dual-wire)
//   - 3376: ShouldDestroyPendingByPointer (found && pointerMatches; dedicated expand residual 3056)
...
//   - 3721: ShouldDestroyPendingByPointer (found && pointerMatches; dedicated expand residual 3056; prior dedicated 3676/3631/3586/3542/3480/3426/3376 retained)
//   - 3766: ShouldDestroyPendingByPointer (found && pointerMatches; dedicated expand residual 3056; prior dedicated 3721/3676/3631/3586/3542/3480/3426/3376 retained)
//   - 3811: ShouldDestroyPendingByPointer (found && pointerMatches; dedicated expand residual 3056; prior dedicated 3766/3721/3676/3631/3586/3542/3480/3426/3376 retained)
//   - 3856: ShouldDestroyPendingByPointer (found && pointerMatches; dedicated expand residual 3056; prior dedicated 3811/3766/3721/3676/3631/3586/3542/3480/3426/3376 retained)
//   - 3901: ShouldDestroyPendingByPointer (found && pointerMatches; dedicated expand residual 3056; prior dedicated 3856/3811/3766/3721/3676/3631/3586/3542/3480/3426/3376 retained)
...
// dual-wire: 3056; prior dedicated expand residual: 3376 / 3426 / 3480 / 3542 / 3586 / 3631 / 3676 / 3721 / 3766 / 3811 / 3856;
// dedicated expand residual: 3901. Sibling dual-wire: 3066
...
// sibling dual-wire: 3056 residual / 3376 / 3426 / 3480 / 3542 / 3586 / 3631 / 3676 / 3721 / 3766 / 3811 / 3856 prior dedicated /
// 3901 dedicated ShouldDestroyPendingByPointer.
//
...
//
// Formula (slice 3901 dual-wire; prior dedicated expand 3856 / 3811 / 3766 /
// 3721 / 3676 / 3631 / 3586 / 3542 / 3480 / 3426 / 3376 / residual expand 3056 /
// pure 2787 — formula unchanged):
...
// slice 3426 / slice 3480 / slice 3542 / slice 3586 / slice 3631 / slice 3676 /
// slice 3721 / slice 3766 / slice 3811 / slice 3856.
// Dedicated expand residual: slice 3901.
...
//
// Host inject (destroyPendingSession(MapSession*)):
//   found          = pending[session->charID] != nullptr;
//   pointerMatches = pending[session->charID] == session;
//   if (ShouldDestroyPendingByPointer(found, pointerMatches)) erase/delete;
...
// slice 3056 residual / 3376 / 3426 / 3480 / 3542 / 3586 / 3631 / 3676 / 3721 / 3766 / 3811 / 3856 prior dedicated / 3901
...
//
// Formula (slice 3218 dual-wire; residual expand 2978 / pure 2799 — formula
// unchanged):
...
//
// Host inject (cleanupSessions, >5s branch):
//   hasChar         = PChar != nullptr;
//   alreadyLinkDead = hasChar && PChar->isLinkDead;
//   if (ShouldMarkLinkDead(hasChar, alreadyLinkDead)) PlanLinkDeadMark(...);
