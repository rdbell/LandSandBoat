...
//   - 3372: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997)
//   - 3420: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3372)
//   - 3474: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3420 / 3372)
//   - 3540: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3474 / 3420 / 3372)
//   - 3584: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3540 / 3474 / 3420 / 3372)
//   - 3629: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3584 / 3540 / 3474 / 3420 / 3372)
//   - 3674: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3629 / 3584 / 3540 / 3474 / 3420 / 3372)
//   - 3719: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372)
//   - 3764: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372)
//   - 3809: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3764 / 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372)
//   - 3854: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3809 / 3764 / 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372)
//   - 3899: ShouldBumpItemsCountOnSetEntry dedicated dual-wire
//           (bump_items_count.go; expand residual 2997; prior dedicated 3854 / 3809 / 3764 / 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372)
//
// Dual-wire index:
//   - 2962: ShouldAllowSetConfirmedStatus residual dual-wire suite
//   - 2984: ShouldSetTradeItemEntry residual dual-wire suite
...
//   - 3809: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//   - 3854: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//   - 3899: ShouldBumpItemsCountOnSetEntry = slotInRange
//
...
// Prior dedicated dual-wire suites: 3372 (test_trade_bump_items_count_3372),
// 3420 (test_trade_bump_items_count_3420), 3474 (test_trade_bump_items_count_3474),
// 3540 (test_trade_bump_items_count_3540), 3584 (test_trade_bump_items_count_3584),
// 3629 (test_trade_bump_items_count_3629), 3674 (test_trade_bump_items_count_3674),
// 3719 (test_trade_bump_items_count_3719), 3764 (test_trade_bump_items_count_3764),
// 3809 (test_trade_bump_items_count_3809), 3854 (test_trade_bump_items_count_3854).
// Dedicated dual-wire suite: 3899 (test_trade_bump_items_count_3899).
// Prior pure port: slice 2812.
...
// ShouldSetTradeItemEntry (3211 / residual 2984), ShouldBumpItemsCountOnSetEntry (3899 / residual 2997; prior dedicated 3854 / 3809 / 3764 / 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372).
...
// ShouldAllowSetConfirmedStatus (3300), ShouldBumpItemsCountOnSetEntry (3899 / residual 2997; prior dedicated 3854 / 3809 / 3764 / 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372).
...
// ---------------------------------------------------------------------------
// Slice 3899 — multi-arg setItem ItemsCount bump (dedicated expand residual 2997)
// ---------------------------------------------------------------------------
...
//
// Formula (slice 3899 dedicated dual-wire; residual expand 2997 / pure 2812 —
// prior dedicated 3854 / 3809 / 3764 / 3719 / 3674 / 3629 / 3584 / 3540 / 3474 / 3420 / 3372; formula unchanged):
...
// test_trade_bump_items_count_2997. Prior dedicated dual-wire suites: 3372 /
// test_trade_bump_items_count_3372, 3420 / test_trade_bump_items_count_3420,
// 3474 / test_trade_bump_items_count_3474, 3540 / test_trade_bump_items_count_3540,
// 3584 / test_trade_bump_items_count_3584, 3629 / test_trade_bump_items_count_3629,
// 3674 / test_trade_bump_items_count_3674, 3719 / test_trade_bump_items_count_3719,
// 3764 / test_trade_bump_items_count_3764, 3809 / test_trade_bump_items_count_3809,
// 3854 / test_trade_bump_items_count_3854.
// Dedicated dual-wire suite is test_trade_bump_items_count_3899. Sibling dual-wire:
