...
//   - 3420: ShouldBumpItemsCountOnSetEntry dedicated dual-wire
...
//   - 3372: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//   - 3420: ShouldBumpItemsCountOnSetEntry = slotInRange
//
...
// Prior dedicated dual-wire suite: 3372 (test_trade_bump_items_count_3372).
// Dedicated dual-wire suite: 3420 (test_trade_bump_items_count_3420).
// Prior pure port: slice 2812.
...
// ShouldSetTradeItemEntry (3211 / residual 2984), ShouldBumpItemsCountOnSetEntry (3420 / residual 2997; prior dedicated 3372).
...
// ShouldAllowSetConfirmedStatus (3300), ShouldBumpItemsCountOnSetEntry (3420 / residual 2997; prior dedicated 3372).
...
// ---------------------------------------------------------------------------
// Slice 3420 — multi-arg setItem ItemsCount bump (dedicated expand residual 2997)
// ---------------------------------------------------------------------------
...
//
// Formula (slice 3420 dedicated dual-wire; residual expand 2997 / pure 2812 —
// prior dedicated 3372; formula unchanged):
...
// test_trade_bump_items_count_2997. Prior dedicated dual-wire suite: 3372 /
// test_trade_bump_items_count_3372. Dedicated dual-wire suite is
// test_trade_bump_items_count_3420. Sibling dual-wire:
