...
//   - 3584: ShouldBumpItemsCountOnSetEntry dedicated dual-wire
...
//   - 3474: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//   - 3540: ShouldBumpItemsCountOnSetEntry prior dedicated dual-wire
//   - 3584: ShouldBumpItemsCountOnSetEntry = slotInRange
//
...
// 3540 (test_trade_bump_items_count_3540).
// Dedicated dual-wire suite: 3584 (test_trade_bump_items_count_3584).
// Prior pure port: slice 2812.
...
// ShouldSetTradeItemEntry (3211 / residual 2984), ShouldBumpItemsCountOnSetEntry (3584 / residual 2997; prior dedicated 3540 / 3474 / 3420 / 3372).
...
// ShouldAllowSetConfirmedStatus (3300), ShouldBumpItemsCountOnSetEntry (3584 / residual 2997; prior dedicated 3540 / 3474 / 3420 / 3372).
...
// ---------------------------------------------------------------------------
// Slice 3584 — multi-arg setItem ItemsCount bump (dedicated expand residual 2997)
// ---------------------------------------------------------------------------
...
//
// Formula (slice 3584 dedicated dual-wire; residual expand 2997 / pure 2812 —
// prior dedicated 3540 / 3474 / 3420 / 3372; formula unchanged):
...
// Dedicated dual-wire suite is test_trade_bump_items_count_3584. Sibling dual-wire:
