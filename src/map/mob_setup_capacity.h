...
// skill assignment (slice 1623). Dual-wire free function under
// mobutilshelpers lives in mobutils_capacity.h (slice 3450 dedicated expand
// residual 3022; prior dedicated 3392; prior re-index 3131; residual dual-wire
// 3022). Formula:
//
...
// Dual-wire: mobutilshelpers::GuardSkillRank (mobutils_capacity.h, 3450);
