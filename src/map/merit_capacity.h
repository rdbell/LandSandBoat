...
//   - 3716: ShouldLowerMerit dedicated dual-wire expand residual 3054
//
...
// Sibling dual-wire: ShouldLowerMerit (3716 expand residual 3054) is independent.
...
// --- Slice 3716: ShouldLowerMerit dedicated dual-wire expand residual 3054 ---
// Dual-wire index:
...
// Go dual-wire: merit.ShouldLowerMerit (internal/merit/lower_merit.go; slice 3716).
...
// test_merit_lower_merit_3716 (dedicated expand residual 3054; not in
// CMake/main). Residual 3054 / prior dedicated 3671 / 3626 / 3581 / 3537 / 3478 / 3424 / 3373 / 3256 suites retained.
//
// Dual-wire notes (slice 3716):
//   Formula unchanged from pure 2810 / residual dual-wire 3054 / prior dedicated
//   3671 / 3626 / 3581 / 3537 / 3478 / 3424 / 3373 / 3256:
//     ShouldLowerMerit(count) = count > 0
//   free == inline == pin == pin3671 (direct return). Residual poles (0, 1, n) + dense.
//   Residual 3054 / prior dedicated 3671 / 3626 / 3581 / 3537 / 3478 / 3424 / 3373 / 3256 suites retained.
//
// ShouldLowerMerit mirrors the LowerMerit count-decrement gate.
//
// Formula (slice 3716 dedicated dual-wire expand residual 3054; pure 2810 /
// residual 3054 / prior dedicated 3671 / 3626 / 3581 / 3537 / 3478 / 3424 / 3373 / 3256 — formula unchanged):
//   count > 0
//
...
//
// Dual-wire of Go merit.ShouldLowerMerit (lower_merit.go / slice 3716).
...
// Coverage: test_merit_lower_merit_3716 (dedicated expand residual 3054;
// not in CMake/main); residual 3054 / prior dedicated 3671 / 3626 / 3581 / 3537 / 3478 / 3424 / 3373 / 3256 suites retained.
...
// ShouldRaiseMerit (3160), ShouldLowerMerit (3716 expand residual 3054).
