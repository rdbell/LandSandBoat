...
//   - 3424: ShouldLowerMerit dedicated dual-wire expand residual 3054
//
...
// Sibling dual-wire: ShouldLowerMerit (3424 expand residual 3054) is independent.
...
// --- Slice 3424: ShouldLowerMerit dedicated dual-wire expand residual 3054 ---
// Dual-wire index:
...
// Go dual-wire: merit.ShouldLowerMerit (internal/merit/lower_merit.go; slice 3424).
...
// test_merit_lower_merit_3424 (dedicated expand residual 3054; not in
// CMake/main). Residual 3054 / prior dedicated 3373 / 3256 suites retained.
//
// Dual-wire notes (slice 3424):
...
//   Residual 3054 / prior dedicated 3373 / 3256 suites retained.
//
// ShouldLowerMerit mirrors the LowerMerit count-decrement gate.
//
// Formula (slice 3424 dedicated dual-wire expand residual 3054; pure 2810 /
// residual 3054 / prior dedicated 3373 / 3256 — formula unchanged):
//   count > 0
//
...
//
// Dual-wire of Go merit.ShouldLowerMerit (lower_merit.go / slice 3424).
...
// Coverage: test_merit_lower_merit_3424 (dedicated expand residual 3054;
// not in CMake/main); residual 3054 / prior dedicated 3373 / 3256 suites retained.
...
// ShouldRaiseMerit (3160), ShouldLowerMerit (3424 expand residual 3054).
