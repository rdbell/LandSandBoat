...
//   - 3313: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3283; formula unchanged: antiHQMod == 0)
//   - 3508: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3313; formula unchanged: antiHQMod == 0)
//   - 3569: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3508; formula unchanged: antiHQMod == 0)
//   - 3614: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3569; formula unchanged: antiHQMod == 0)
//   - 3659: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3614; formula unchanged: antiHQMod == 0)
//   - 3704: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3659; formula unchanged: antiHQMod == 0)
//   - 3749: CanSynthesizeHQ prior dedicated dual-wire expand residual 2876
//           (prior ~3704; formula unchanged: antiHQMod == 0)
//   - 3794: CanSynthesizeHQ dedicated dual-wire expand residual 2876
...
//     prior dedicated dual-wire expand residual 2876 (prior ~3283)
//   - 3508: CanSynthesizeHQ = antiHQMod == 0
//     prior dedicated dual-wire expand residual 2876 (prior ~3313)
//   - 3569: CanSynthesizeHQ = antiHQMod == 0
//     prior dedicated dual-wire expand residual 2876 (prior ~3508)
//   - 3614: CanSynthesizeHQ = antiHQMod == 0
//     prior dedicated dual-wire expand residual 2876 (prior ~3569)
//   - 3659: CanSynthesizeHQ = antiHQMod == 0
//     prior dedicated dual-wire expand residual 2876 (prior ~3614)
//   - 3704: CanSynthesizeHQ = antiHQMod == 0
//     prior dedicated dual-wire expand residual 2876 (prior ~3659)
//   - 3749: CanSynthesizeHQ = antiHQMod == 0
//     prior dedicated dual-wire expand residual 2876 (prior ~3704)
//   - 3794: CanSynthesizeHQ = antiHQMod == 0
//     dedicated dual-wire expand residual 2876 (prior ~3749)
//
...
// residual 2876), test_synthutils_can_synthesize_hq_3313 (prior dedicated
// expand residual 2876), test_synthutils_can_synthesize_hq_3508 (prior
// dedicated expand residual 2876), test_synthutils_can_synthesize_hq_3569
// (prior dedicated expand residual 2876), test_synthutils_can_synthesize_hq_3614
// (prior dedicated expand residual 2876), test_synthutils_can_synthesize_hq_3659
// (prior dedicated expand residual 2876), test_synthutils_can_synthesize_hq_3704
...
// 3749 prior dedicated / 3794 expand residual 2876 — canSynthesizeHQ pure half
// (anti-HQ mod gate)
// ---------------------------------------------------------------------------
// Dual-wire notes (slice 3794):
...
//   Skill→Mod catalog mapping remains host/mod-table work.
// Coverage: test_synthutils_can_synthesize_hq_3794 (dedicated expand residual
// 2876; not in CMake/main); residual 2876 + prior dedicated 3244 / 3283 /
// 3313 / 3508 / 3569 / 3614 / 3659 / 3704 / 3749 suites retained.
...
//
// Formula (slice 3794 dedicated dual-wire expand residual 2876; prior
// dedicated 3749 / 3704 / 3659 / 3614 / 3569 / 3508 / 3313 / 3283 / 3244 / pure 1922 —
// formula unchanged):
//   CanSynthesizeHQ(antiHQMod) = antiHQMod == 0
//
// true when antiHQMod == 0 (no blocking ring/mod).
// Host still owns skillID → Mod mapping and PChar->getMod.
// Dual-wire of Go synthutils.CanSynthesizeHQ (can_hq.go / slice 3794).
