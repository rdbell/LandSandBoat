...
//   - 3122: ShouldUpdateMaxCharges residual dual-wire (expanded 3391 / 3448 / 3519 / 3564)
...
//           (retained)
//   - 3564: ShouldUpdateMaxCharges (maxCharges != 0 update gate on Load existing;
...
// Load host injects maxCharges != 0 into ShouldUpdateMaxCharges (slice 3564;
// prior dedicated 3519 / 3448 / 3391; residual dual-wire 3122).
...
//
// Formula (slice 3564 dual-wire expand residual 3122; prior dedicated 3519 /
// 3448 / 3391):
//   maxChargesNonzero
//
...
// expand residual 3122: 3519 / 3448 / 3391 (retained). Siblings 3052/3070/3255/
// 3104/3360 left alone this slice (do not thrash update_charge_time).
